...
const SEED_DATA = [
  {
    ...
    concepts: [
      createConcept("1. ¿Qué es un acto jurídico?", "Manifestación de voluntad hecha con el propósito de crear, modificar o extinguir derechos y obligaciones, y que produce los efectos queridos por su autor o por las partes porque el derecho sanciona dicha manifestación de voluntad. (Víctor Vial)"),
      createConcept("2. ¿Cómo se clasifica el acto jurídico?", "El acto jurídico se clasifica en: 1. Unilateral y bilateral. 2. A título gratuito o a título oneroso. 3. Conmutativos o aleatorios. 4. Puros y simples, o sujetos a modalidad. 5. Consensuales, reales o solemnes. 6. De familia o patrimoniales. 7. Principales y accesorios. 8. Solemnes o no solemnes. 9. Típicos o nominados, y atípicos o innominados. 10. De disposición o administración. 11. De ejecución instantánea, ejecución diferida o indefinido. 12. Constitutivos, traslaticios o declarativos. 13. Entre vivos o por causa de muerte. 14. Verdaderos o simulados."),
      createConcept("3. ¿Qué es un acto jurídico unilateral y bilateral?", "Esta clasificación obedece al número de voluntades que se requiere para que el acto jurídico se forme. Acto Jurídico Unilateral: aquel para cuyo nacimiento requiere de la manifestación de voluntad de una sola parte. Ejemplo: testamento, la oferta y la aceptación. Acto Jurídico Bilateral (o Convención): aquel para cuyo nacimiento requiere de la manifestación de voluntad de dos o más partes. Ejemplo: contratos, tradición, el matrimonio, entre otros."),
      createConcept("4. ¿Convención y contrato son sinónimos?", "No. La convención es un acto jurídico bilateral destinado a crear, modificar o extinguir derechos y obligaciones. Por su parte, el contrato es un acto jurídico bilateral destinado exclusivamente a crear derechos y obligaciones. Por tanto existe una relación de género (convención) y especie (contrato)."),
      createConcept("5. ¿Qué es un acto jurídico gratuito y oneroso?", "Esta clasificación se efectúa en atención a si el acto jurídico procura ventaja o utilidad a una sola de las partes o de ambos contratantes. Acto Jurídico Gratuito: aquel que solo tiene por objeto la utilidad de una de las partes, sufriendo la otra el gravamen. Acto Jurídico Oneroso: aquel que tiene por objeto la utilidad de ambas partes contratantes, gravándose cada uno a beneficio del otro."),
      createConcept("6. ¿Qué es un acto jurídico conmutativo y aleatorio?", "Los actos jurídicos onerosos se subclasifican en conmutativos o aleatorios, atendiendo a la determinación de la equivalencia de las prestaciones. Acto Jurídico Conmutativo: cuando cada una de las partes se obliga a dar o hacer una cosa que se mira como equivalente a lo que la otra parte debe dar o hacer a su vez. Acto Jurídico Aleatorio: cuando el equivalente consiste en una contingencia incierta de ganancia o pérdida."),
      createConcept("7. ¿Qué es un acto jurídico principal o accesorio?", "Esta clasificación atiende a si el acto jurídico subsiste por sí mismo, sin necesidad de otra convención. Acto Jurídico principal: aquel que subsiste por sí mismo sin necesidad de otra convención. Acto Jurídico accesorio: cuando no puede subsistir sin otro acto jurídico principal al cual accede. Los actos jurídicos accesorios a su vez se subclasifican en: acto jurídico de garantía o dependiente."),
      createConcept("8. ¿Qué es una caución?", "Art. 46 CC: Caución significa generalmente cualquiera obligación que se contrae para la seguridad de otra obligación propia o ajena. Son especies de caución la fianza, la hipoteca y la prenda."),
      createConcept("9. ¿Qué es un acto jurídico real, solemne o consensual?", "Esta clasificación atiende a la forma de perfeccionar el acto jurídico. Acto Jurídico Real: aquel que se perfecciona con la tradición o entrega de la cosa a que se refiere. Acto Jurídico Solemne: aquel que está sujeto a la observación de ciertas formalidades especiales, de manera que sin ellas no produce efecto civil. Acto Jurídico Consensual: aquel que se perfecciona por el solo consentimiento."),
      createConcept("10. ¿Qué es un acto jurídico puro y simple o sujeto a modalidad?", "Esta clasificación atiende a si los efectos del acto jurídico se producen de inmediato o están sujetos a alguna modalidad. Acto Jurídico Simple: aquellos que producen sus efectos de inmediato, sin limitación de ninguna especie. Acto Jurídico sujeto a Modalidad: aquellos en que sus efectos se encuentran subordinados al cumplimiento de una modalidad, esto es, ciertas cláusulas que se incorporan a un acto jurídico con el fin de alterar sus efectos normales."),
      createConcept("11. ¿Cuáles son las características de las modalidades del acto jurídico?", "A. Por regla general constituyen un elemento accidental; por excepción pueden ser de la esencia (ej. el plazo en el usufructo, la condición en la propiedad fiduciaria) o de la naturaleza (ej. condición resolutoria tácita). B. Son excepcionales: la regla general es que el acto es puro y simple. C. No se presumen; las partes deben incluirlas expresamente (excepciones: Arts. 1489 y 738 CC). D. Por regla general proceden en actos patrimoniales (excepciones: Arts. 1277 y 1192 CC). E. Las principales modalidades son: la condición, el plazo y el modo. Algunos autores agregan la representación y la solidaridad."),
      createConcept("12. ¿Qué es el plazo?", "Art. 1494 CC. Definición legal: El plazo es la época que se fija para el cumplimiento de la obligación, y puede ser expreso o tácito. Definición doctrinaria: hecho futuro y cierto, del cual pende el ejercicio o extinción de un derecho."),
      createConcept("13. ¿Qué es una condición?", "Art. 1473 CC. Definición legal: Es obligación condicional la que depende de una condición, esto es, de un acontecimiento futuro que puede suceder o no. Definición doctrinaria: hecho futuro e incierto del cual depende el nacimiento o la extinción de un derecho."),
      createConcept("14. ¿Qué es el modo?", "Los autores lo han definido como Gravamen que se impone al beneficiario de una liberalidad o la obligación accesoria de realizar una prestación impuesta al adquirente de un derecho."),
      createConcept("15. ¿Qué es la representación?", "Art. 1448 CC. Definición legal: Lo que una persona ejecuta a nombre de otra, estando facultada por ella o por la ley para representarla, produce respecto del representado iguales efectos que si hubiese contratado él mismo. Definición doctrinaria: figura jurídica por la cual las consecuencias de un acto jurídico celebrado por una persona a nombre de otra, afectan en forma directa e inmediata a esta última tal como si ella misma hubiese actuado, y puede tener su origen en la ley o en la voluntad del representado."),
      createConcept("16. ¿Cuáles son las fuentes de la representación?", "A. Legal: aquella que deriva de la ley, sin que intervenga la voluntad del interesado. B. Voluntaria: emana de la voluntad de las partes y puede tener su origen en un contrato (mandato) o en un cuasicontrato (agencia oficiosa), en la cual habrá representación si el negocio fue bien administrado."),
      createConcept("17. ¿Quiénes son representantes legales de una persona?", "Art. 43 CC: Son representantes legales de una persona el padre o la madre, el adoptante y su tutor o curador. Alessandri estima que este artículo no es taxativo, pues hay otros casos de representantes designados por la ley, por ejemplo, el juez que representa al deudor en las ventas forzadas."),
      createConcept("18. ¿Es lo mismo representación que mandato?", "No. Diferencias: a. El mandato supone un contrato, mientras que la representación puede tener distintas fuentes (la representación es el género y el mandato una especie de representación voluntaria). b. La representación es independiente del mandato; puede haber mandato sin representación y viceversa. c. La facultad de representar no es de la esencia del mandato sino de la naturaleza, ya que es posible que el mandatario no represente al mandante."),
      createConcept("19. ¿Cuáles son los requisitos para que exista representación?", "1. Celebración de un acto jurídico. 2. Declaración de voluntad del representante. 3. El representante debe actuar a nombre del representado al contratar (contemplatio domini). 4. Existencia de poder, es decir, que quien obra por cuenta de otro debe estar facultado para representarlo."),
      createConcept("20. ¿Cuáles son los elementos del acto o contrato?", "Art. 1444 CC: Se distinguen en cada contrato las cosas que son de su esencia, las que son de su naturaleza, y las puramente accidentales. Son de la esencia aquellas cosas sin las cuales o no produce efecto alguno, o degenera en otro contrato diferente; son de la naturaleza las que no siendo esenciales, se entienden pertenecerle sin necesidad de cláusula especial; y son accidentales aquellas que ni esencial ni naturalmente le pertenecen, y que se le agregan por medio de cláusulas especiales."),
      createConcept("21. ¿Cuáles son los requisitos de existencia del acto jurídico?", "Los requisitos de existencia son: 1. La voluntad. 2. El objeto. 3. La causa. 4. Solemnidades en aquellos actos en que la ley lo exige."),
      createConcept("22. ¿Cuáles son los requisitos de validez del acto jurídico?", "Los requisitos de validez son: 1. Voluntad exenta de vicio. 2. Capacidad de las partes. 3. Objeto lícito. 4. La causa lícita. Algunos autores agregan las solemnidades exigidas por la ley para la validez del acto."),
      createConcept("23. ¿Qué es la voluntad?", "Dícese de la aptitud para querer algo, o facultad humana que impele a realizar, o no, alguna cosa."),
      createConcept("24. ¿Cuáles son los requisitos para que la voluntad origine efectos jurídicos?", "Los requisitos de la voluntad son: 1. Debe ser seria: cuando se emite con la intención de producir efectos jurídicos. 2. Debe manifestarse: la voluntad se debe exteriorizar (ya sea en forma expresa o tácita), no puede quedar en el fuero interno."),
      createConcept("25. ¿El silencio constituye manifestación de voluntad?", "Por regla general no constituye manifestación de voluntad. Sin embargo, excepcionalmente se le entrega valor en tres casos: 1. Cuando la ley le asigna valor (ej. Arts. 1767, 1233, 2125 CC). 2. Cuando las partes del contrato así lo han convenido (ej. cláusulas de renovación automática en el arrendamiento). 3. Caso del Silencio Circunstanciado: cuando las circunstancias que acompañan al silencio permiten al juez atribuirle el carácter de manifestación de voluntad."),
      createConcept("26. ¿Qué es el consentimiento?", "Acuerdo de las voluntades de dos o más partes, dirigido a producir efectos jurídicos."),
      createConcept("27. ¿Cuáles son los actos necesarios para que se forme el consentimiento?", "Se forma por la concurrencia de dos actos jurídicos unilaterales: 1. La oferta: acto jurídico unilateral mediante el cual una persona propone a otra celebrar determinada convención, bastando para que ésta se perfeccione la aceptación de aquél a quien fue dirigida. 2. La aceptación de la oferta: acto jurídico unilateral mediante el cual su destinatario da a conocer que está conforme con ella. La regulación está en el Código de Comercio (Arts. 97 al 108), no en el Código Civil."),
      createConcept("28. ¿Cuáles son los vicios del consentimiento?", "Art. 1451 CC: Los vicios de que puede adolecer el consentimiento, son error, fuerza y dolo. Algunos autores agregan la lesión enorme."),
      createConcept("29. ¿Qué es el error?", "Es el falso concepto que se tiene de la realidad o la disconformidad que existe entre las ideas de nuestra mente y el orden de las cosas."),
      createConcept("30. ¿Cómo se clasifica el error?", "El error puede ser de derecho o de hecho. El error de hecho a su vez puede ser: error esencial, sustancial, accidental y en la persona."),
      createConcept("31. ¿El error de derecho vicia el consentimiento?", "Art. 1452 CC: El error sobre un punto de derecho no vicia el consentimiento. Excepcionalmente la ley admite que pueda alegarse error de derecho, así ocurre en el cuasicontrato de pago de lo no debido (Arts. 2297 y 2299 CC). Relacionar con Arts. 8 y 706 inciso final CC."),
      createConcept("32. ¿En qué consiste el error esencial?", "Art. 1453 CC: El error de hecho vicia el consentimiento cuando recae sobre la especie de acto o contrato que se ejecuta o celebra, como si una de las partes entendiese empréstito y la otra donación; o sobre la identidad de la cosa específica de que se trata, como si en el contrato de venta el vendedor entendiese vender cierta cosa determinada, y el comprador entendiese comprar otra. Puede ser in negotio (en el acto jurídico) o in corpore (en la identidad de la cosa)."),
      createConcept("33. ¿En qué consiste el error sustancial?", "Art. 1454 inciso 1 CC: es aquel que se produce cuando la sustancia o calidad esencial del objeto sobre que versa el acto o contrato, es diversa de lo que se cree; como si por alguna de las partes se supone que el objeto es una barra de plata, y realmente es una masa de algún otro metal semejante."),
      createConcept("34. ¿En qué consiste el error accidental?", "Art. 1454 inciso 2 CC: el error accidental recae sobre una cualidad no esencial de la cosa. Por regla general no vicia el consentimiento. Para que lo vicie se requiere: 1. Que la calidad accidental haya sido el motivo principal de una de las partes para contratar. 2. Que ese motivo haya sido conocido por la otra parte."),
      createConcept("35. ¿En qué consiste el error en la persona?", "Art. 1455 CC: El error acerca de la persona con quien se tiene intención de contratar no vicia el consentimiento, salvo que la consideración de esta persona sea la causa principal del contrato. Pero en este caso la persona que erró tendrá derecho a ser indemnizada de los perjuicios en que de buena fe haya incurrido por la nulidad del contrato."),
      createConcept("36. ¿Cómo se sanciona el error?", "El error sustancial, accidental y en la persona (previo cumplimiento de requisitos) se sanciona con nulidad relativa. La sanción del error esencial es discutida: algunos señalan inexistencia por falta de voluntad; quienes no recogen la inexistencia, nulidad absoluta; y otros postulan nulidad relativa."),
      createConcept("37. ¿Qué es el error común?", "Es aquel compartido por un gran número de personas, de manera tal que produce la validación de un acto que en principio adolecía de nulidad. Requisitos: 1. Debe existir un error. 2. Debe ser compartido o susceptible de serlo por un gran número de personas. 3. Debe ser excusable (justo motivo para incurrir en él). 4. Debe padecerse de buena fe."),
      createConcept("38. ¿Definición de fuerza?", "Apremios físicos o morales que se ejercen sobre una persona destinada a que ella preste su consentimiento para la celebración de un acto jurídico. Víctor Vial."),
      createConcept("39. ¿Cómo se clasifica la fuerza?", "La fuerza puede ser física o moral. A. Física: empleo de medios o procedimientos materiales de violencia (ej. conducirle la mano al declarante). No vicia el consentimiento pues lo suprime. B. Moral: amenazas de un mal que será inferido a una persona en caso de no consentir. Esta fuerza es la que vicia el consentimiento."),
      createConcept("40. ¿Cuáles son los requisitos para que la fuerza vicie el consentimiento?", "1. Debe ser injusta, contraria a la ley o al derecho. 2. Debe ser grave, de acuerdo al artículo 1456 CC. 3. Debe ser determinante: obra de la contraparte o un tercero con el fin de obtener la manifestación de voluntad, y sin ella no se hubiera prestado el consentimiento. 4. Debe ser actual o inminente, coetánea al acto o contrato."),
      createConcept("41. ¿Cuándo la fuerza es grave?", "Art. 1456 CC: La fuerza no vicia el consentimiento, sino cuando es capaz de producir una impresión fuerte en una persona de sano juicio, tomando en cuenta su edad, sexo y condición. Se mira como una fuerza de este género todo acto que infunde a una persona un justo temor de verse expuesta ella, su consorte o alguno de sus ascendientes o descendientes a un mal irreparable y grave."),
      createConcept("42. ¿Qué es el temor reverencial?", "Art. 1456 inciso 2 CC: El temor reverencial, esto es, el solo temor de desagradar a las personas a quienes se debe sumisión y respeto, no basta para viciar el consentimiento."),
      createConcept("43. ¿Cómo se sanciona la fuerza?", "La fuerza física se sanciona con inexistencia o nulidad absoluta, por falta de voluntad o consentimiento. La fuerza moral se sanciona con nulidad relativa."),
      createConcept("44. ¿Qué es el dolo?", "El dolo como vicio del consentimiento es toda maquinación fraudulenta empleada para engañar al autor o contraparte de un acto o contrato, con el fin de arrancarle una declaración de voluntad o modificarla en los términos deseados por el individuo que actúa dolosamente, el cual no habría consentido de no mediar el engaño."),
      createConcept("45. ¿Cuál es el ámbito de aplicación del dolo?", "El dolo se puede estudiar desde tres puntos de vista: A. Como vicio del consentimiento. B. Como elemento agravante de la responsabilidad del deudor por incumplimiento de su obligación (Art. 1558 CC). C. Como elemento constitutivo de la responsabilidad extracontractual (Art. 2284 inciso 3 CC)."),
      createConcept("46. ¿Cómo se clasifica el dolo?", "A. Dolo positivo (maniobras directas para engañar) y dolo negativo (simple ocultación de un hecho que, conocido por la contraparte, le hubiera impedido contratar). B. Dolo bueno (comportamiento lícito, astucia o halagos permitidos) y dolo malo (comportamiento ilícito destinado a engañar). C. Dolo principal o directo (induce directamente a la declaración de voluntad) y dolo incidental (no es determinante, pero trae la celebración del acto en condiciones desfavorables)."),
      createConcept("47. ¿A quién le corresponde probar el dolo?", "Por regla general, al que ha sido víctima de la maquinación fraudulenta. Art. 1459 CC: El dolo no se presume sino en los casos especialmente previstos por la ley. En los demás debe probarse. Excepcionalmente se presume en: Art. 706 inciso final, 968 n°5, 1301, 2510 n°3 y 94 n°1 del CC."),
      createConcept("48. ¿Cuáles son los requisitos para que el dolo vicie el consentimiento?", "Art. 1458 CC: El dolo no vicia el consentimiento sino cuando es obra de una de las partes, y cuando además aparece claramente que sin él no hubieran contratado. En los actos jurídicos unilaterales basta que sea determinante, ya que solo existe una parte."),
      createConcept("49. ¿Cómo se sanciona el dolo?", "Si cumple los requisitos del Art. 1458 inciso 1: nulidad relativa. Si no los reúne, se aplica el Art. 1458 inciso 2: solo da lugar a la acción de perjuicios contra quienes lo fraguaron (por el total de los perjuicios) o se aprovecharon de él (hasta concurrencia del provecho reportado)."),
      createConcept("50. ¿Se puede condonar el dolo futuro?", "Art. 1465 CC: La condonación del dolo futuro no vale y constituye un caso de objeto ilícito, el cual será sancionado con nulidad absoluta."),
      createConcept("51. ¿En qué consiste el dolo del incapaz?", "Art. 1685 CC: Si de parte del incapaz ha habido dolo para inducir al acto o contrato, ni él ni sus herederos o cesionarios podrán alegar nulidad. Sin embargo, la aserción de mayor edad, o de no existir la interdicción u otra causa de incapacidad, no inhabilitará al incapaz para obtener el pronunciamiento de nulidad."),
      createConcept("52. ¿Qué se entiende por lesión?", "La lesión es el detrimento patrimonial que una parte experimenta cuando, en un contrato conmutativo, recibe de la otra un valor sustancialmente inferior al de la prestación suministrada por ella. El perjuicio nace de la desigualdad."),
      createConcept("53. ¿En qué materias se aplica la lesión enorme?", "La lesión enorme se regula en: 1. Compraventa de bien inmueble (Arts. 1889 y 1890 CC). 2. Permuta de bien inmueble (Art. 1900 CC). 3. Aceptación de una asignación hereditaria (Art. 1234 CC). 4. Partición de bienes (Art. 1348 CC). 5. Mutuo (Art. 2206 en relación con Art. 8 Ley 18.010). 6. Anticresis (Art. 2443 CC). 7. Cláusula penal enorme (Art. 1544 CC). 8. Liquidación de la sociedad conyugal (Art. 1776 CC)."),
      createConcept("54. ¿Cuál es la sanción a la lesión enorme?", "En general, la sanción de la lesión es la nulidad relativa del acto en que incide o la reducción de la desproporción de las prestaciones."),
      createConcept("55. ¿Qué es el objeto?", "El objeto consiste en los derechos y obligaciones que el acto jurídico crea, modifica o extingue. (Eugenio Velasco)"),
      createConcept("56. ¿Cómo se regula el objeto en nuestro Código Civil?", "Art. 1460 CC: Toda declaración de voluntad debe tener por objeto una o más cosas que se trata de dar, hacer o no hacer. Se ha criticado este artículo porque confunde el objeto de la declaración de voluntad con el objeto de la obligación. Podemos distinguir: Objeto del acto jurídico: obligación y derecho que genera. Objeto de la obligación: la prestación. Objeto de la prestación: una o más cosas que se deben dar, hacer o no hacer."),
      createConcept("57. ¿Cuáles son los requisitos del objeto?", "Cuando recae en una cosa que debe darse o entregarse: a. Real. b. Determinado. c. Comerciable. Cuando recae en un hecho: a. Debe ser determinado o determinable. b. Debe ser físicamente posible. c. Debe ser moralmente posible."),
      createConcept("58. ¿Qué es el objeto ilícito?", "Es aquel contrario al orden público, a las buenas costumbres o la ley. El Código señala determinados casos: 1. Actos que contravienen el derecho público chileno (Art. 1462). 2. Pactos sobre sucesiones futuras (Art. 1463). 3. Enajenación de cosas del Art. 1464. 4. Condonación del dolo futuro (Art. 1465). 5. Deudas contraídas en juegos de azar (Art. 1466). 6. Ventas de libros u objetos prohibidos o inmorales (Art. 1466). 7. Actos prohibidos por la ley (Art. 1466)."),
      createConcept("59. ¿Qué casos se contemplan en el artículo 1464?", "Art. 1464 CC: Hay un objeto ilícito en la enajenación: 1°. De las cosas que no están en el comercio; 2°. De los derechos o privilegios que no pueden transferirse a otra persona; 3°. De las cosas embargadas por decreto judicial, a menos que el juez lo autorice o el acreedor consienta en ello; 4°. De especies cuya propiedad se litiga, sin permiso del juez que conoce en el litigio."),
      createConcept("60. ¿Qué es la causa?", "Art. 1467 inciso 2 CC: Se entiende por causa el motivo que induce al acto o contrato; y por causa ilícita la prohibida por ley, o contraria a las buenas costumbres o al orden público."),
      createConcept("61. ¿Cuáles son los requisitos de la causa?", "1. Debe ser real: debe existir al momento en que se celebra el contrato o acto jurídico. El Art. 1467 señala: No puede haber obligación sin una causa real y lícita; pero no es necesario expresarla. La pura liberalidad o beneficencia es causa suficiente. 2. Debe ser lícita: aquella que no es contraria a la ley, a las buenas costumbres o al orden público."),
      createConcept("62. ¿Qué tipos de causa se distinguen en los actos jurídicos?", "1. Eficiente: el elemento generador del acto, en general las fuentes de las obligaciones. 2. Ocasional: el fin estrictamente personal que se persigue con la celebración del acto. 3. Final: el fin o motivo por el cual se celebra el acto o contrato; es la misma en todos los actos jurídicos de la misma especie. 4. Económica: el fin económico que las partes persiguen al contratar."),
      createConcept("63. ¿El Código Civil a qué causa se refiere?", "Para la mayoría de la doctrina se refiere a la causa final, por tanto, en cada tipo de contrato habrá siempre una misma causa de valor constante y abstracto, precisada de antemano por el Derecho."),
      createConcept("64. ¿Qué es la causa ilícita?", "Art. 1467 inciso 2 CC: Se entiende por causa ilícita la prohibida por ley, o contraria a las buenas costumbres o al orden público."),
      createConcept("65. ¿Qué es la capacidad?", "La aptitud legal de una persona para contraer derechos y obligaciones, ejercerlos por sí misma sin el ministerio o la autorización de otra persona."),
      createConcept("66. ¿Cómo se clasifica la capacidad?", "La capacidad puede ser de goce y de ejercicio. La capacidad de goce es la aptitud de una persona para adquirir derechos. La capacidad de ejercicio, definida en el Art. 1445 inciso final: La capacidad legal de una persona consiste en poderse obligar por sí misma, y sin el ministerio o la autorización de otra."),
      createConcept("67. ¿Quiénes son incapaces absolutos y relativos?", "Art. 1447 CC. Son absolutamente incapaces: el demente, los impúberes y los sordos o sordomudos que no pueden darse a entender claramente. Son incapaces relativos: los menores adultos y los disipadores que se hallen bajo interdicción de administrar lo suyo."),
      createConcept("68. ¿Qué son las formalidades?", "Aquellos requisitos que dicen relación con la forma o aspecto externo del acto jurídico, exigidos por la ley con diferentes finalidades y cuya omisión se sancionará en la forma prevista por el legislador."),
      createConcept("69. ¿Cómo se clasifican las formalidades?", "Las formalidades pueden ser: A. Propiamente tales o solemnidades. B. Formalidades habilitantes. C. Formalidades por vía de prueba. D. Formalidades de publicidad."),
      createConcept("70. ¿Cuáles son las formalidades propiamente tales?", "Son los requisitos externos prescritos por la ley como indispensables para la existencia misma o para la validez del acto jurídico, exigidos en atención a la naturaleza del acto. Pueden ser: Solemnidades de existencia (el único medio a través del cual se puede manifestar la voluntad en ciertos actos) y Solemnidades de validez (exigidas en atención al valor y naturaleza del acto)."),
      createConcept("71. ¿Qué ejemplos de solemnidad de existencia y validez existen?", "Solemnidades de existencia: contrato de promesa debe constar por escrito (Art. 1554 N°1); compraventa de bienes raíces por escritura pública (Art. 1801 inc. 2); hipoteca por escritura pública (Art. 2409); presencia de oficial del registro civil o ministro de culto en el matrimonio. Solemnidades de validez: presencia de tres o cinco testigos en el testamento solemne (Arts. 1014 y 1021); insinuación en la donación (Art. 1401); presencia de dos testigos en el matrimonio (Art. 17 LMC)."),
      createConcept("72. ¿Cuáles son las formalidades habilitantes?", "Son aquellas que se requieren para cumplir con los requisitos externos exigidos por la ley en atención a la calidad o estado de las personas que ejecutan o celebran el acto. Son requisitos exigidos para completar la voluntad de un incapaz o para protegerlo. Pueden ser de tres tipos: A. Autorización. B. Asistencia. C. Homologación."),
      createConcept("73. ¿Cuáles son las formalidades de prueba?", "Son aquellas requeridas por la ley como medio de prueba de un acto no solemne y que se traducen en la exigencia de que exista un documento, de forma que si éste falta, el acto tiene validez, pero no es posible su prueba a través de testigos (Arts. 1708, 1709 incs. 1 y 2; 1710 inc. 1 y 1711 inc. 1 CC)."),
      createConcept("74. ¿Cuáles son las formalidades de publicidad?", "Son los requisitos externos exigidos por la ley para poner en conocimiento de los terceros el otorgamiento o celebración de un acto, y en algunos casos para que sea eficaz ante terceros. Puede ser de simple noticia (poner en conocimiento de terceros las relaciones jurídicas en que puedan tener interés; ej. Arts. 447 y 461 CC) o sustanciales (precaver a los terceros interesados; ej. Art. 1902 CC)."),
      createConcept("75. ¿Qué es la ineficacia del acto jurídico?", "Corresponde a la pérdida de efectos de un acto jurídico. Puede ser: de origen (inexistencia o nulidad), o sobrevenida (resolución, revocación, resciliación, caducidad, inoponibilidad)."),
      createConcept("76. ¿Qué es la nulidad?", "Art. 1681 CC: La nulidad es una sanción para todo acto o contrato a que falta alguno de los requisitos que la ley prescribe para el valor del mismo acto o contrato según su especie (nulidad absoluta) y la calidad o estado de las partes (nulidad relativa)."),
      createConcept("77. ¿Cuáles son las causales de nulidad absoluta?", "Art. 1682 CC. Son causales de nulidad absoluta: objeto ilícito, causa ilícita, omisión de algún requisito o formalidad que la ley prescribe para el valor del acto en consideración a su naturaleza, y actos y contratos de personas absolutamente incapaces. Quienes rechazan la teoría de la inexistencia agregan: falta de voluntad, de objeto, de causa, de solemnidades de existencia y error esencial."),
      createConcept("78. ¿Quién puede solicitar la nulidad absoluta?", "Art. 1683 CC: puede y debe ser declarada por el juez cuando aparece de manifiesto en el acto o contrato; puede alegarse por todo el que tenga interés en ello (interés actual y pecuniario), excepto el que ejecutó el acto sabiendo o debiendo saber el vicio que lo invalidaba; puede pedirse por el ministerio público en el interés de la moral o de la ley."),
      createConcept("79. ¿Se puede sanear la nulidad absoluta?", "Art. 1683 parte final CC: sólo se puede sanear por el transcurso de 10 años desde la celebración del acto o contrato."),
      createConcept("80. ¿Cuáles son las causales de nulidad relativa?", "Son causales de nulidad relativa: incapacidad relativa; error sustancial; error accidental cuando haya sido el principal motivo para contratar y era conocido por la otra parte; error en la persona cuando haya sido determinante; fuerza moral, grave, injusta y determinante; dolo determinante; omisión de algún requisito o formalidad en relación a la calidad o estado de las personas que ejecuten el acto; lesión, en ciertos casos."),
      createConcept("81. ¿Quién puede solicitar la nulidad relativa?", "Art. 1684 CC: La nulidad relativa no puede ser declarada por el juez sino a pedimento de parte; ni puede pedirse su declaración por el ministerio público en el solo interés de la ley; ni puede alegarse sino por aquellos en cuyo beneficio la han establecido las leyes o por sus herederos o cesionarios."),
      createConcept("82. ¿Cómo se puede sanear la nulidad relativa?", "Art. 1684 parte final CC: se produce el saneamiento por el lapso del tiempo y por ratificación o confirmación de las partes."),
      createConcept("83. ¿Cuál es el plazo para solicitar la nulidad relativa?", "Art. 1691 CC: el plazo es de cuatro años. Este cuadrienio se contará según la causal: 1. Fuerza moral: desde el día en que ésta hubiere cesado. 2. Error o dolo: desde el día de la celebración del acto o contrato. 3. Incapacidad legal: desde el día en que haya cesado esta incapacidad. Todo ello en los casos en que leyes especiales no hubieren designado otro plazo."),
      createConcept("84. ¿Se suspende el plazo para solicitar la nulidad relativa?", "Art. 1692 CC: sí, se suspende por la muerte del beneficiado, quien transmitirá a sus herederos. A. Herederos mayores de edad: gozan del cuadrienio entero si no hubiere principiado a correr, y del residuo en caso contrario. B. Herederos menores: el cuadrienio o su residuo empieza a correr desde que llegaren a edad mayor. En este caso no se podrá pedir la nulidad pasados 10 años desde la celebración del acto."),
      createConcept("85. ¿Qué es la confirmación o ratificación?", "Acto jurídico unilateral en virtud del cual la parte que tenía derecho de alegar la nulidad relativa renuncia a esa facultad saneando el vicio de que adolecía el acto o contrato. (Arturo Alessandri)"),
      createConcept("86. ¿Cuáles son los tipos de confirmación?", "Arts. 1693 y siguientes CC. La ratificación puede ser: 1. Expresa: se formula una declaración en la cual, en términos explícitos y formales, se manifiesta la voluntad de validar un determinado acto. 2. Tácita: consiste en la ejecución voluntaria de la obligación contraída o convenida."),
      createConcept("87. ¿Cuáles son los efectos de la nulidad entre las partes?", "Art. 1687 CC: La nulidad pronunciada en sentencia que tiene la fuerza de cosa juzgada, da a las partes derecho para ser restituidas al mismo estado en que se hallarían si no hubiese existido el acto o contrato nulo; sin perjuicio de lo prevenido sobre el objeto o causa ilícita. Si las obligaciones no se cumplieron, la nulidad opera como modo de extinguirlas."),
      createConcept("88. ¿Cuáles son los efectos de la nulidad respecto de terceros?", "Art. 1689 CC: La nulidad judicialmente pronunciada da acción reivindicatoria contra terceros poseedores; sin perjuicio de las excepciones legales."),
      createConcept("89. ¿Qué es la conversión del acto nulo?", "El medio jurídico en virtud del cual un negocio se salva de la nulidad, convirtiéndose en otro diferente que sustituye al primero, salvaguardado en lo posible el fin perseguido por las partes. (José Luis de los Mozos)"),
      createConcept("90. ¿Qué es la resolución?", "La pérdida de efectos de un acto jurídico, como consecuencia de haber operado una condición resolutoria tácita, la que generalmente produce efectos retroactivos de manera tal que las partes vuelven al mismo estado en que se encontraban al momento de celebrar el acto jurídico y por lo tanto se entiende que éste nunca ha existido."),
      createConcept("91. ¿Qué es la revocación?", "Una declaración unilateral de voluntad que consiste en la retractación de un acto jurídico precedente, incluso bilateral, consentida por la ley al autor de dicha retractación. Por ejemplo, la revocación del testamento o del mandato."),
      createConcept("92. ¿Qué es la resciliación?", "La resciliación es aquella convención en virtud de la cual las partes, de común acuerdo, estipulan dejar sin efecto un contrato válidamente celebrado, en la medida que sus efectos no estén totalmente cumplidos."),
      createConcept("93. ¿Qué es la caducidad?", "La caducidad tiene diversos significados: 1. Pérdida de un derecho por no hacerlo valer en el plazo legal o contractual. 2. Ineficacia de un acto jurídico por el solo ministerio de la ley, a causa de hechos sobrevinientes (ej. testamentos privilegiados, Art. 1212 CC). 3. Exigibilidad anticipada de las obligaciones, como la caducidad del plazo. 4. Extinción de usufructos sucesivos o alternativos o de fideicomisos sucesivos."),
      createConcept("94. ¿Qué es la inoponibilidad?", "Es la ineficacia de un acto jurídico o de su nulidad, respecto de ciertos terceros, por no haber cumplido las partes algún requisito externo de eficacia, dirigido precisamente a proteger a esos terceros."),
      createConcept("95. ¿Qué es la suspensión?", "Hay suspensión del acto jurídico cuando los efectos de éste, para tener lugar, están subordinados a la ocurrencia de un hecho que aún no se ha verificado. Tal hecho puede emanar de las partes o de la ley. Por ejemplo, mediante una condición suspensiva o un plazo suspensivo pactados por los contratantes, o mediante una condición legal (ej. en el testamento, las disposiciones están supeditadas a la muerte del causante)."),
      createConcept("96. ¿Qué es el desistimiento unilateral?", "Es aquel que se produce cuando una de las partes decide y comunica a la otra el término de la relación contractual. Este derecho es excepcional y puede ejercitarse solo cuando la ley lo establece o los contratantes lo pactan. Por ejemplo, el desahucio en el contrato de arrendamiento."),
      createConcept("97. ¿Qué es la simulación?", "Declaración de un contenido de voluntad no real, emitida conscientemente y de acuerdo entre las partes para producir, con fines de engaño, la apariencia de un negocio jurídico que no existe o que es distinto de aquel que realmente se ha llevado a cabo. (Francisco Ferrara)"),
      createConcept("98. ¿Cómo se clasifica la simulación?", "La simulación puede ser: A. Lícita o ilícita: según si tiene o no por finalidad perjudicar a terceros o violar la ley. B. Absoluta o relativa: según si se contempla un único acto simulado, o dos actos (el simulado y el disimulado)."),
      createConcept("99. ¿Cuáles son los requisitos de la simulación?", "Los requisitos para que exista simulación son: 1. Declaración que, deliberadamente, se contrapone con la verdadera intención de las partes. 2. Que tal declaración haya sido concertada por las partes. 3. Que el fin perseguido por las partes sea el engaño a terceros."),
      createConcept("100. ¿Cuáles son los efectos de la simulación?", "A. Entre las partes: el acto simulado no existe, rigiéndose éstas por su voluntad real. Por regla general las partes extienden una contraescritura, que se regirá por el artículo 1707 CC. B. Respecto de terceros: prevalecerá la voluntad declarada por las partes (el acto aparente), ya que es el que los terceros conocen; la voluntad real de las partes no afecta a terceros por regla general."),
    ],
  },
  {
  ...
  },
  {
    ...
    concepts: [
      createConcept("1. ¿Qué son los bienes?", "Los bienes son cosas que, pudiendo procurar al hombre una utilidad, son susceptibles de apropiación por los particulares. En doctrina se distingue 'cosa y bien'. En cambio, para el Código Civil, cosa y bien se utilizan como sinónimos."),
      createConcept("2. ¿Cómo se clasifican los bienes?", "Los bienes o cosas se clasifican en: 1. Cosas corporales e incorporales. 2. Cosas corporales muebles e inmuebles. 3. Cosas específicas y genéricas. 4. Cosas consumibles y no consumibles. 5. Cosas fungibles y no fungibles. 6. Cosas divisibles e indivisibles. 7. Cosas presentes y cosas futuras. 8. Cosas principales y accesorias. 9. Cosas comerciables y no comerciables. 10. Cosas singulares y universales. 11. Cosas apropiables e inapropiables. 12. Bienes particulares o nacionales."),
      createConcept("3. ¿En qué consisten las cosas corporales e incorporales?", "Corporales son las que tienen un ser real y pueden ser percibidas por los sentidos, como una casa, un libro. Las cosas corporales se clasifican en bienes muebles e inmuebles. Incorporales las que consisten en meros derechos, como los créditos, y las servidumbres activas. Las cosas incorporales pueden consistir en derechos reales y personales."),
      createConcept("4. ¿Qué son los bienes muebles e inmuebles?", "Bienes muebles: los que pueden transportarse de un lugar a otro sin detrimento de su sustancia. Se clasifican en mueble por naturaleza y mueble por anticipación. Bienes inmuebles o fincas o bienes raíces: los que no pueden transportarse sin que se altere su sustancia. Se clasifican en inmueble por naturaleza, por adherencia y por destinación."),
      createConcept("5. ¿Qué importancia tiene distinguir entre bienes muebles e inmuebles?", "1. La tradición de inmuebles se realiza por inscripción en el CBR; la de muebles por simple entrega. 2. La compraventa de mueble es consensual; la de inmueble es solemne. 3. Para incapaces, los requisitos son más estrictos para enajenar bienes raíces. 4. La hipoteca recae solo sobre inmuebles; la prenda solo sobre muebles. 5. La posesión de inmuebles se adquiere, prueba y conserva mediante inscripción. 6. Prescripción ordinaria: 2 años (muebles), 5 años (inmuebles). 7. La acción rescisoria por lesión enorme solo procede en venta o permuta de inmuebles."),
      createConcept("6. ¿Qué son los bienes muebles por naturaleza?", "Son los que pueden transportarse de un lugar a otro sin detrimento de su sustancia. Se dividen en: A. Semovientes: se trasladan moviéndose por sí solos, como los animales. B. Inanimados: requieren fuerza externa para trasladarse, como un libro."),
      createConcept("7. ¿Qué son los bienes muebles por anticipación?", "Son bienes inmuebles por naturaleza, por adherencia o por destinación que, para el efecto de constituir un derecho sobre ellos en favor de persona distinta del dueño, se reputan muebles antes de su separación del inmueble al que pertenecen."),
      createConcept("8. ¿Qué son los bienes inmuebles por naturaleza?", "Inmuebles o fincas o bienes raíces son las cosas que no pueden transportarse de un lugar a otro, como las tierras y minas."),
      createConcept("9. ¿Qué son los bienes inmuebles por adherencia?", "Son aquellos bienes que adhieren permanentemente a las cosas que no pueden transportarse de un lugar a otro, como los edificios y los árboles."),
      createConcept("10. ¿Qué son los bienes inmuebles por destinación?", "Son bienes muebles que se reputan inmuebles al estar permanentemente destinados al uso, cultivo y beneficio de un inmueble, aunque puedan separarse sin detrimento."),
      createConcept("11. ¿Cuándo los derechos y acciones se reputan bienes muebles o inmuebles?", "Se reputan muebles o inmuebles según lo sea la cosa en que han de ejercerse o que se debe. El derecho de usufructo sobre un inmueble es inmueble; la acción del comprador para que se le entregue la finca comprada es inmueble; la acción del que prestó dinero para que se le pague es mueble."),
      createConcept("12. ¿Los hechos que se deben se reputan muebles o inmuebles?", "Los hechos que se deben se reputan muebles. La acción para que un artífice ejecute la obra convenida o resarza los perjuicios causados por la inejecución del convenio entra en la clase de los bienes muebles."),
      createConcept("13. ¿Cómo pueden ser los bienes incorporales?", "Las cosas incorporales consisten en meros derechos: Derecho real (art. 577 CC): el que tenemos sobre una cosa sin respecto a determinada persona. Derecho personal (art. 578 CC): los que solo pueden reclamarse de ciertas personas que han contraído las obligaciones correlativas."),
      createConcept("14. ¿Cuáles son los derechos reales?", "Son derechos reales el de dominio, el de herencia, los de usufructo, uso o habitación, los de servidumbres activas, el de prenda y el de hipoteca. Fuera de la enumeración del art. 577, existen otros como el derecho de aprovechamiento de aguas o de concesiones mineras."),
      createConcept("15. ¿Cuáles son los elementos del derecho real?", "1. Sujeto activo: persona natural o jurídica titular del derecho real. 2. Objeto: la cosa sobre la cual recae el derecho. 3. Sujeto pasivo: la comunidad, obligada a abstenerse de perturbar el derecho real."),
      createConcept("16. ¿Cuáles son los elementos del derecho personal?", "1. Sujeto activo o acreedor: titular del derecho, quien puede exigir el cumplimiento. 2. Sujeto pasivo o deudor: quien debe cumplir la obligación. 3. Objeto: la prestación, que puede ser un hecho positivo o negativo."),
      createConcept("17. ¿Cuál es la fuente de un derecho real y un derecho personal?", "La fuente de los derechos reales son los modos de adquirir. Los derechos personales surgen de las fuentes de las obligaciones: contrato, cuasicontrato, delito, cuasidelito y la ley (arts. 578, 1437 y 2284 CC)."),
      createConcept("18. ¿Cuáles son las diferencias entre derecho real y personal?", "1. Los reales son limitados (solo la ley puede crearlos); los personales son ilimitados. 2. Los reales se constituyen por modos de adquirir; los personales por fuentes de obligaciones. 3. El sujeto pasivo del derecho real es indeterminado (la colectividad); el del personal es determinado. 4. El objeto del derecho real es una cosa; el del personal es una prestación. 5. El derecho real es absoluto (oponible a todos); el personal es relativo (solo contra el obligado)."),
      createConcept("19. ¿Qué son las cosas específicas y genéricas?", "Cosas específicas o cuerpos ciertos: determinadas por características propias que las distinguen de todas las demás del mismo género. Cosas genéricas: diferenciadas solo por características comunes a todos los individuos del mismo género."),
      createConcept("20. ¿Qué son las cosas consumibles y no consumibles?", "Son objetivamente consumibles las que, por sus caracteres específicos, se destruyen natural o civilmente por el primer uso. Son no consumibles las que no se destruyen por el primer uso, como un cuaderno o un automóvil. Esta distinción solo aplica a bienes muebles."),
      createConcept("21. ¿Qué son las cosas fungibles y no fungibles?", "Son fungibles las que pueden ser reemplazadas por otras equivalentes y tienen igual poder liberatorio, como monedas, vino o agua. Son no fungibles las que tienen individualidad propia y no admiten reemplazo, como un cuadro de Da Vinci."),
      createConcept("22. ¿Qué son las cosas divisibles e indivisibles?", "Materialmente divisibles: las que pueden fraccionarse sin destruirse ni perder notablemente su valor. Intelectualmente divisibles: las que pueden fraccionarse en partes ideales o imaginarias aunque no puedan serlo materialmente."),
      createConcept("23. ¿Qué son las cosas presentes y cosas futuras?", "Son bienes presentes los que tienen existencia real al momento de constituirse la relación jurídica. Son bienes futuros los que no existen al momento de celebrarse el acto jurídico, pero se espera que existan."),
      createConcept("24. ¿Qué son las cosas comerciables e incomerciables?", "Comerciables: pueden ser objeto de relaciones jurídicas privadas y son susceptibles de dominio por particulares. Incomerciables: no pueden ser objeto de relaciones jurídicas por particulares ni susceptibles de dominio privado."),
      createConcept("25. ¿Qué es el derecho real de dominio?", "El dominio (o propiedad) es el derecho real en una cosa corporal, para gozar y disponer de ella arbitrariamente, no siendo contra la ley o contra derecho ajeno. La propiedad separada del goce de la cosa se llama mera o nuda propiedad."),
      createConcept("26. ¿Cuáles son las características del dominio?", "A. Es un derecho real. B. Es absoluto: otorga la plenitud de derechos sobre la cosa (uso, goce y disposición). C. Es exclusivo: supone un titular único. D. Es perpetuo: no está limitado en el tiempo. Excepción: propiedad fiduciaria."),
      createConcept("27. ¿Cuáles son los atributos del dominio?", "Uso: servirse de la cosa según el fin al que está destinada. Goce: aprovecharse de los frutos naturales y civiles. Disposición: destruir materialmente la cosa, transformarla, conservarla o enajenarla."),
      createConcept("28. ¿Se puede limitar la facultad de enajenar?", "Sí, por disposición de la ley (arts. 819, 1464, 1192 CC) o por voluntad del hombre mediante cláusulas de no enajenar (ej. en el usufructo, la propiedad fiduciaria o la donación, arts. 793, 751 y 1432 N°1 CC)."),
      createConcept("29. ¿Cómo se clasifica el derecho de propiedad?", "Según su extensión: plena, nuda, absoluta o fiduciaria. Según su titular: individual o copropiedad/condominio. Según su objeto: civil, intelectual e industrial."),
      createConcept("30. ¿Qué es la comunidad y la copropiedad?", "La comunidad (art. 2304 CC) es una especie de cuasicontrato entre dos o más personas sobre una cosa universal o singular. La copropiedad es el derecho de propiedad de dos o más personas sobre una misma cosa pro indiviso, correspondiendo a cada una una parte alícuota, ideal y abstracta. La comunidad es el género y la copropiedad es la especie."),
      createConcept("31. ¿Qué son los modos de adquirir el dominio?", "Son hechos jurídicos a los cuales la ley atribuye la facultad de hacer nacer o traspasar el dominio: 1. Ocupación. 2. Accesión. 3. Tradición. 4. Sucesión por causa de muerte. 5. Prescripción adquisitiva. 6. La ley."),
      createConcept("32. ¿Cómo se clasifican los modos de adquirir el dominio?", "A. Originarios o derivativos. B. A título universal o singular. C. A título oneroso o gratuito. D. Por acto entre vivos o por causa de muerte."),
      createConcept("33. ¿Qué es la ocupación?", "Es un modo de adquirir el dominio de las cosas que no pertenecen a nadie, cuya adquisición no está prohibida por las leyes chilenas o el Derecho Internacional, mediante la aprehensión material con intención de adquirir el dominio."),
      createConcept("34. ¿Cuáles son las características de la ocupación?", "1. Es un modo entre vivos. 2. Es a título gratuito. 3. Es originario. 4. Es a título singular. 5. Opera solo respecto de cosas corporales muebles. 6. Para algunos es un acto jurídico; para otros, un hecho jurídico."),
      createConcept("35. ¿Cuáles son los requisitos de la ocupación?", "1. Que se trate de cosas sin dueño. 2. Que la adquisición no esté prohibida por la ley chilena o el Derecho Internacional. 3. Aprehensión material de la cosa. 4. Intención de adquirir el dominio."),
      createConcept("36. ¿Qué es la accesión?", "Es un modo de adquirir por el cual el dueño de una cosa pasa a serlo de lo que ella produce o de lo que se junta a ella. Los productos de las cosas son frutos naturales o civiles."),
      createConcept("37. ¿Cuáles son las características de la accesión?", "1. Es un modo entre vivos. 2. Generalmente es a título gratuito. 3. Es originario. 4. Es a título singular. 5. Recae solo sobre cosas corporales. 6. Es un hecho jurídico."),
      createConcept("38. ¿Cuáles son las clases de accesión?", "1. Accesión de frutos o discreta (generación de frutos). 2. Accesión propiamente tal o continua: A. De inmueble a inmueble: aluvión, avulsión, mutación del álveo, formación de nuevas islas. B. De mueble a mueble: adjunción, especificación, mezcla. C. De mueble a inmueble: edificación, plantación, siembra."),
      createConcept("39. ¿Cómo se clasifican los frutos y en qué estado pueden encontrarse?", "Frutos naturales: los que da la naturaleza ayudada o no de la industria humana. Estados: pendiente, percibidos, consumidos. Frutos civiles: utilidades o rendimientos equivalentes al uso y goce de la cosa por un tercero. Estados: pendiente, percibidos, devengados."),
      createConcept("40. ¿Qué es la tradición?", "Es un modo de adquirir el dominio que consiste en la entrega que el dueño hace de la cosa a otro, habiendo por una parte la facultad e intención de transferir el dominio, y por otra la capacidad e intención de adquirirlo."),
      createConcept("41. ¿Cuáles son las características de la tradición?", "1. Es un modo entre vivos. 2. Puede ser a título oneroso o gratuito. 3. Es derivativo. 4. Por regla general es a título singular, salvo la tradición del derecho real de herencia. 5. Sirve para adquirir el dominio y demás derechos reales. 6. Se refiere a bienes corporales e incorporales. 7. Es un acto jurídico bilateral."),
      createConcept("42. ¿Cuáles son los requisitos de la tradición?", "1. Concurrencia de tradente y adquirente. 2. Consentimiento de ambas partes. 3. Existencia de un título traslaticio de dominio. 4. Entrega de la cosa."),
      createConcept("43. ¿Es válida la tradición si el tradente no es dueño?", "Es válida, pero no transfiere el dominio; solo se adquieren los derechos transmisibles del tradente. Si el tradente adquiere después el dominio, se entiende transferido desde el momento de la tradición (arts. 682 y 683 CC)."),
      createConcept("44. ¿Cómo se efectúa la tradición del dominio y otros derechos reales en inmuebles?", "Por la inscripción del título en el Registro del Conservador de Bienes Raíces. Del mismo modo se realiza la tradición de los derechos de usufructo, uso, habitación, censo e hipoteca sobre inmuebles."),
      createConcept("45. ¿Qué finalidad puede tener la inscripción en el Conservador de Bienes Raíces?", "1. Forma de realizar la tradición de derechos reales sobre inmuebles. 2. Publicidad y mantener la historia de la propiedad raíz. 3. Prueba, requisito y garantía de la posesión de bienes inmuebles. 4. En ciertos actos constituye el cumplimiento de una solemnidad (arts. 1400, 767, 812, 2409 y 2410 CC)."),
      createConcept("46. ¿Cómo se efectúa la tradición de una cosa corporal mueble?", "Significando una de las partes a la otra que le transfiere el dominio, y figurando esta transferencia por uno de los medios que señala el artículo 684 CC."),
      createConcept("47. ¿Cuáles son las formas de realizar la tradición de un bien mueble?", "1°. Permitiéndole la aprehensión material de una cosa presente. 2°. Mostrándosela. 3°. Entregándole las llaves del lugar en que esté guardada. 4°. Encargándose de poner la cosa a disposición del otro en el lugar convenido. 5°. Por la venta, donación u otro título de enajenación conferido al que tiene la cosa como usufructuario, arrendatario, depositario, etc.; y recíprocamente por el mero contrato en que el dueño se constituye en esas calidades."),
      createConcept("48. ¿Cómo se efectúa la tradición de la servidumbre?", "Por escritura pública en que el tradente exprese constituirla y el adquirente la acepte. Esta escritura puede ser la misma del acto o contrato."),
      createConcept("49. ¿Cómo se efectúa la tradición del derecho real de herencia?", "El Código no lo regula expresamente. Existen dos doctrinas: 1. Si la herencia es una universalidad jurídica, se aplican las reglas generales del art. 684 CC. 2. Si se atiende a los bienes singulares, se aplican las reglas de muebles o inmuebles según los bienes que comprenda."),
      createConcept("50. ¿Cómo se efectúa la tradición de los derechos personales?", "La tradición de los derechos personales que un individuo cede a otro se verifica por la entrega del título hecha por el cedente al cesionario."),
      createConcept("51. ¿Cuáles son los efectos de la tradición?", "A. Si el tradente es dueño: la tradición transfiere el dominio en las mismas condiciones en que lo tenía el tradente. B. Si el tradente no es dueño: la tradición es válida, aunque no transfiere el dominio. Se aplican los arts. 682 y 683 CC."),
      createConcept("52. ¿Qué es la posesión?", "La posesión es la tenencia de una cosa determinada con ánimo de señor o dueño, sea que el dueño o el que se da por tal tenga la cosa por sí mismo o por otra persona a su nombre. El poseedor es reputado dueño mientras otra persona no justifica serlo."),
      createConcept("53. ¿Cuáles son los elementos de la posesión?", "El Corpus: poder físico o potestad de hecho sobre la cosa. El Animus: comportarse como propietario, como señor o dueño."),
      createConcept("54. ¿Cuáles son las semejanzas y diferencias entre la posesión y el dominio?", "Semejanzas: A. Ambos recaen en una cosa determinada. B. Ambos son exclusivos. C. Sus utilidades se ejercen de igual modo. Diferencias: A. El dominio es un derecho real; la posesión, un hecho. B. El dominio se adquiere solo por un modo; la posesión puede adquirirse por varios títulos. C. El dominio está protegido por la acción reivindicatoria; la posesión, por las acciones posesorias."),
      createConcept("55. ¿Cómo se clasifica la posesión?", "La posesión puede clasificarse en: regular o irregular; útil o inútil; viciosa o no viciosa; tranquila o no tranquila."),
      createConcept("56. ¿Cuáles son los requisitos de la posesión regular?", "1. Justo título. 2. Buena fe inicial. 3. Tradición (si el título es traslaticio de dominio)."),
      createConcept("57. ¿Qué es un justo título?", "El hecho o acto en que se funda la posesión que, por su naturaleza o por ser verdadero y válido, es apto en abstracto para transferir el dominio."),
      createConcept("58. ¿Cuáles son los títulos injustos?", "1. El falsificado. 2. El conferido por quien actúa como mandatario o representante legal sin serlo, o excediéndose en sus facultades. 3. El que adolece de un vicio de nulidad. 4. El meramente putativo."),
      createConcept("59. ¿De qué clase pueden ser los títulos?", "Constitutivos de dominio: dan origen al dominio (ocupación, accesión, prescripción). Traslaticios de dominio: sirven para transferirlo (venta, permuta, donación). Declarativos de dominio: reconocen una situación preexistente (sentencias judiciales sobre derechos litigiosos)."),
      createConcept("60. ¿Qué es la buena fe en materia de posesión?", "La conciencia de haberse adquirido el dominio de la cosa por medios legítimos, exentos de fraude y de todo otro vicio. En títulos traslaticios, supone la persuasión de haber recibido la cosa de quien tenía facultad de enajenarla."),
      createConcept("61. ¿Cuál es la posesión viciosa?", "Son posesiones viciosas la violenta (adquirida por la fuerza) y la clandestina (ejercida ocultándola a quienes tienen derecho a oponerse)."),
      createConcept("62. ¿Cómo se adquiere, conserva y pierde la posesión de un bien mueble?", "Se adquiere con aprehensión material y voluntad. Se conserva mientras subsistan corpus y animus, o solo el animus. Se pierde cuando se pierden ambos elementos, cuando se pierde el corpus (otro se apodera con ánimo de dueño) o cuando se pierde el animus (constituto posesorio)."),
      createConcept("63. ¿Cómo se adquiere la posesión de un bien inmueble no inscrito?", "Depende del título: si es simple apoderamiento, basta ese hecho. Si es título no traslaticio, no requiere inscripción. Si es título traslaticio: la posesión regular requiere inscripción en el CBR; la posesión irregular se discute en doctrina."),
      createConcept("64. ¿Cómo se adquiere la posesión de un bien inmueble inscrito?", "Si es título constitutivo de dominio, no requiere inscripción. Si es título traslaticio, se requiere inscripción en el CBR para la posesión regular. Para la posesión irregular, una opinión muy minoritaria estima que no se necesita inscripción."),
      createConcept("65. ¿Cómo se pierde la posesión de un bien inmueble inscrito?", "Es necesario que la inscripción se cancele, sea por voluntad de las partes, por una nueva inscripción en que el poseedor transfiere su derecho a otro, o por decreto judicial. Mientras subsista la inscripción, quien se apodera del inmueble no adquiere posesión ni pone fin a la existente."),
      createConcept("66. ¿En qué consiste la teoría de la posesión inscrita?", "La inscripción en el CBR es requisito (nadie puede adquirir posesión de inmuebles sino por inscripción), prueba (la posesión se prueba por la inscripción subsistente por un año completo) y garantía (mientras subsista la inscripción, quien se apodera del inmueble no adquiere posesión)."),
      createConcept("67. ¿Qué es la mera tenencia?", "La que se ejerce sobre una cosa no como dueño, sino en lugar o a nombre del dueño. El mero tenedor reconoce dominio ajeno (ej. acreedor prendario, secuestre, usufructuario, arrendatario)."),
      createConcept("68. ¿Puede el mero tenedor cambiar su calidad a poseedor?", "Por regla general no, la mera tenencia es inmutable (art. 716 CC). Existe una aparente excepción en el art. 2510 n°3 CC, pero la doctrina mayoritaria señala que requiere otros antecedentes además del simple transcurso del tiempo."),
      createConcept("69. ¿Qué es la prescripción adquisitiva?", "Es un modo de adquirir las cosas ajenas, por haberlas poseído durante cierto lapso de tiempo y concurriendo los demás requisitos legales."),
      createConcept("70. ¿Cuáles son las características de la prescripción adquisitiva?", "1. Es un modo entre vivos. 2. Es a título gratuito. 3. Es originario. 4. Generalmente a título singular, salvo prescripción del derecho real de herencia. 5. Sirve para adquirir el dominio y los demás derechos reales, salvo servidumbres discontinuas y continuas inaparentes. 6. La posesión es el elemento fundamental. 7. Naturaleza mixta: hecho (posesión por cierto tiempo) y acto jurídico (alegarla)."),
      createConcept("71. ¿Cuáles son los requisitos de la prescripción adquisitiva?", "1. Que la cosa sea susceptible de ganarse por prescripción. 2. La posesión. 3. Que la prescripción no esté interrumpida. 4. Que no esté suspendida. 5. Transcurso del tiempo."),
      createConcept("72. ¿Qué cosas son susceptibles de ganarse por prescripción?", "La regla general es que todas las cosas sean susceptibles. Por excepción, no lo son: 1. Las cosas fuera del comercio humano. 2. Los derechos de la personalidad. 3. Los derechos personales. 4. Las servidumbres discontinuas y continuas inaparentes. 5. Las cosas indeterminadas. 6. Las cosas propias."),
      createConcept("73. ¿Qué es la interrupción de la prescripción?", "El hecho de la naturaleza o del hombre que, destruyendo uno de los elementos necesarios para prescribir (posesión o inacción del propietario), hace inútil todo el tiempo transcurrido."),
      createConcept("74. ¿Cuándo se produce la interrupción natural?", "1°. Cuando se ha hecho imposible el ejercicio de actos posesorios sin pasar la posesión a otras manos (ej. heredad permanentemente inundada): se descuenta su duración. 2°. Cuando se ha perdido la posesión por haber entrado en ella otra persona: se pierde todo el tiempo, salvo que se haya recobrado legalmente."),
      createConcept("75. ¿Qué es la interrupción civil?", "Todo recurso judicial intentado por el que se pretende verdadero dueño de la cosa contra el poseedor."),
      createConcept("76. ¿En qué casos no se produce la interrupción civil?", "1. Si la notificación de la demanda no fue hecha en forma legal. 2. Si el recurrente desistió expresamente de la demanda. 3. Si se declaró abandonada la instancia. 4. Si el demandado obtuvo sentencia de absolución."),
      createConcept("77. ¿Qué es la suspensión de la prescripción?", "Beneficio legal que impide que la prescripción ordinaria corra contra ciertas personas mientras dura su incapacidad: menores, dementes, sordos/sordomudos que no pueden darse a entender, los bajo potestad paterna o tutela/curaduría, la mujer casada en sociedad conyugal y la herencia yacente."),
      createConcept("78. ¿Cuál es el plazo para adquirir por prescripción adquisitiva?", "Ordinaria (art. 2508): 2 años para muebles, 5 años para bienes raíces. Extraordinaria (art. 2511): 10 años contra toda persona, sin suspensión."),
      createConcept("79. ¿Qué es la acción reivindicatoria?", "La que tiene el dueño de una cosa singular de que no está en posesión, para que el poseedor sea condenado a restituírsela."),
      createConcept("80. ¿Cuáles son los requisitos de la acción reivindicatoria?", "1. Que quien la intenta sea dueño de la cosa. 2. Que haya perdido la posesión. 3. Que se trate de cosas susceptibles de reivindicarse."),
      createConcept("81. ¿Qué son las prestaciones mutuas?", "Las devoluciones e indemnizaciones que recíprocamente se deben el reivindicante y el poseedor vencido."),
      createConcept("82. ¿Qué prestaciones debe el poseedor vencido al reivindicante?", "1. La restitución de la cosa. 2. Pago de los deterioros. 3. Pago de los frutos. 4. Indemnización de gastos de custodia y conservación durante el juicio reivindicatorio."),
      createConcept("83. ¿Qué prestaciones debe el reivindicante al poseedor vencido?", "1. Indemnización de los gastos ordinarios por la producción de los frutos. 2. Indemnización por las mejoras introducidas en la cosa."),
      createConcept("84. ¿En qué consiste el derecho legal de retención del poseedor vencido?", "Cuando el poseedor vencido tuviere un saldo que reclamar en razón de expensas y mejoras, podrá retener la cosa hasta que se verifique el pago o se le asegure a su satisfacción."),
      createConcept("85. ¿Qué son las acciones posesorias?", "Las que tienen por objeto conservar o recuperar la posesión de bienes raíces o de derechos reales constituidos en ellos."),
      createConcept("86. ¿Cuáles son las características de las acciones posesorias?", "1. Naturaleza inmueble. 2. Nace de un hecho, no de un derecho, pero se califica de acción real porque puede ejercerse sin respecto a determinada persona. 3. Tiene por objeto la conservación o recuperación de la posesión. 4. Se requiere posesión tranquila y no interrumpida por un año. 5. Queda a salvo el derecho a discutir el dominio posteriormente."),
      createConcept("87. ¿Cuáles son los requisitos para entablar una acción posesoria?", "1. Posesión tranquila y no interrumpida durante un año completo. 2. El objeto debe ser susceptible de acción posesoria. 3. Perturbación o despojo de la posesión. 4. Que la acción no esté prescrita."),
      createConcept("88. ¿Qué es la querella de amparo?", "Acción que tiene por objeto conservar la posesión de bienes raíces o de derechos reales constituidos en ellos."),
      createConcept("89. ¿Qué es la querella de restitución?", "Acción para recuperar la posesión de bienes raíces o derechos reales cuando el poseedor ha sido injustamente privado de ella."),
      createConcept("90. ¿Qué es la querella de restablecimiento?", "Acción concedida al que ha sido despojado violentamente de la posesión o mera tenencia de un inmueble, para que le sea restituida en el estado existente antes del acto de violencia."),
      createConcept("91. ¿Qué es la acción publiciana?", "La que se concede, aunque no se pruebe dominio, al que ha perdido la posesión regular de la cosa y se hallaba en el caso de poderla ganar por prescripción."),
      createConcept("92. ¿Qué es la propiedad fiduciaria?", "La que está sujeta al gravamen de pasar a otra persona por el hecho de verificarse una condición."),
      createConcept("93. ¿Cuáles son los requisitos de la propiedad fiduciaria?", "1. Que la cosa sea susceptible de darse en fideicomiso. 2. Existencia del constituyente, propietario fiduciario y del fideicomisario. 3. Existencia de una condición. 4. Cumplimiento de las solemnidades o formalidades."),
      createConcept("94. ¿Cómo se constituye la propiedad fiduciaria?", "Los fideicomisos no pueden constituirse sino por acto entre vivos otorgado en instrumento público, o por acto testamentario. La constitución de todo fideicomiso que comprenda o afecte un inmueble deberá inscribirse en el competente Registro."),
      createConcept("95. ¿Qué es el usufructo?", "Derecho real que consiste en la facultad de gozar de una cosa con cargo de conservar su forma y sustancia y de restituirla a su dueño, o de devolver igual cantidad y calidad del mismo género o pagar su valor si la cosa es fungible."),
      createConcept("96. ¿Cuáles son las características del usufructo?", "1. Es un derecho real de goce. 2. Es una limitación al dominio. 3. Es temporal. 4. Es intransmisible. 5. El usufructuario es dueño de su derecho (puede ejercer acción reivindicatoria). 6. El usufructuario es mero tenedor de la cosa dada en usufructo."),
      createConcept("97. ¿Cuáles son los requisitos del usufructo?", "1. Cosas susceptibles de usufructo. 2. Sujetos: constituyente, nudo propietario y usufructuario. 3. Existencia de un plazo."),
      createConcept("98. ¿Se puede constituir dos o más usufructos sucesivos o alternativos?", "Se prohíbe. Si de hecho se constituyeren, los usufructuarios posteriores se consideran como substitutos para el caso de faltar los anteriores. El primer usufructo que tenga efecto hará caducar los otros, pero no durará sino por el tiempo designado."),
      createConcept("99. ¿Qué es el derecho de uso y habitación?", "El derecho de uso es un derecho real que consiste en la facultad de gozar de una parte limitada de las utilidades y productos de una cosa. Si se refiere a una casa y a la utilidad de morar en ella, se llama derecho de habitación."),
      createConcept("100. ¿Qué es la servidumbre?", "Art. 820 CC: Servidumbre predial, o simplemente servidumbre, es un gravamen impuesto sobre un predio en utilidad de otro predio de distinto dueño."),
    ],
  },
  {
    ...createModule("Contratos Parte Especial"),
    concepts: [
      createConcept("1. ¿Qué es el contrato de promesa?", "Es aquel en que dos o más personas se comprometen a celebrar un contrato futuro, cumpliéndose los requisitos legales (Arturo Alessandri)."),
      createConcept("2. ¿Cuáles son las características del contrato de promesa?", "a. Contrato Principal. b. Contrato Solemne. c. Contrato Preparatorio. d. Puede ser Unilateral o Bilateral. e. De derecho estricto. f. Puede ser a título gratuito u oneroso. g. Contrato sujeto a modalidad (plazo o condición). h. Genera una obligación indivisible, de hacer. i. Genera una acción de carácter mueble."),
      createConcept("3. ¿Cuáles son los requisitos del contrato de promesa?", "Art. 1554 CC: 1ª. Que la promesa conste por escrito. 2ª. Que el contrato prometido no sea de aquellos que las leyes declaran ineficaces. 3ª. Que la promesa contenga un plazo o condición que fije la época de la celebración del contrato. 4ª. Que en ella se especifique de tal manera el contrato prometido, que sólo falten para que sea perfecto, la tradición de la cosa, o las solemnidades que las leyes prescriban."),
      createConcept("4. ¿Cuáles son los efectos del contrato de promesa?", "Genera una obligación de hacer. Si se cumple: se extingue la promesa y pasa a tener vida el contrato definitivo. Si no se cumple: se puede solicitar al juez que apremie al contratante renuente para que celebre el contrato, y de negarse, que suscriba dicho contrato por la parte rebelde o que declare resuelto el contrato y ordene indemnización de perjuicios (arts. 1553 y 1489 CC)."),
      createConcept("5. ¿Qué es el contrato de compraventa?", "Art. 1793 CC: La compraventa es un contrato en que una de las partes se obliga a dar una cosa y la otra a pagarla en dinero. Aquélla se dice vender y ésta comprar. El dinero que el comprador da por la cosa vendida se llama precio."),
      createConcept("6. ¿Cuáles son las características del contrato de compraventa?", "a. Contrato Bilateral. b. Contrato Oneroso. c. Generalmente conmutativo. d. Contrato Principal. e. Regla general es consensual, excepcionalmente solemne. f. Regla general de ejecución instantánea, excepcionalmente diferida. g. Es un título traslaticio de dominio. h. Regla general los gastos son a cargo del vendedor."),
      createConcept("7. ¿Cuáles son los requisitos del contrato de compraventa?", "1. Consentimiento. 2. La cosa vendida: debe ser comerciable, existir o esperarse que exista, determinada y singular, y no ser propiedad del comprador. 3. El precio: debe ser en dinero, real y determinado."),
      createConcept("8. ¿La compraventa de cosa ajena es válida?", "Art. 1815 CC: La venta de cosa ajena vale, sin perjuicio de los derechos del dueño de la cosa vendida, mientras no se extingan por el lapso de tiempo."),
      createConcept("9. ¿Cuáles son las modalidades particulares de la compraventa?", "1. Venta con arras: suma de dinero o cosas muebles que se dan en garantía de la celebración del contrato o como parte del precio (Arts. 1803-1805). 2. Venta a peso, cuenta o medida: necesario pesar, contar o medir para determinar la cosa o el precio (Art. 1821). 3. Venta al gusto o prueba: no hay contrato mientras el comprador no declara que le agrada la cosa (Art. 1823)."),
      createConcept("10. ¿Cómo se perfecciona el contrato de compraventa?", "Art. 1801 CC: La venta se reputa perfecta desde que las partes han convenido en la cosa y en el precio. Excepción: la venta de bienes raíces, servidumbre, censos y sucesión hereditaria no se reputa perfecta mientras no se haya otorgado escritura pública."),
      createConcept("11. ¿Cuáles son las obligaciones del vendedor y del comprador?", "Obligaciones del vendedor: 1. Entrega o tradición de la cosa. 2. Saneamiento de la cosa vendida. 3. Conservar la especie o cuerpo cierto hasta la entrega. Obligaciones del comprador: 1. Pagar el precio. 2. Recibir la cosa comprada."),
      createConcept("12. ¿Cómo debe efectuarse la entrega en la compraventa?", "Art. 1824 CC: Bien mueble: significando una de las partes a la otra que le transfiere el dominio, por alguna de las formas del art. 684. Bien inmueble: mediante la inscripción del contrato en el CBR. Se ha discutido si basta la inscripción, señalándose que también debe comprender la entrega material del inmueble."),
      createConcept("13. ¿En qué consiste la obligación de saneamiento?", "Tiene dos objetos: A. Amparar al comprador en el dominio y posesión pacífica de la cosa. B. Responder de los defectos ocultos o redhibitorios. Es una obligación de la naturaleza (puede excluirse), eventual, y supone una deficiencia jurídica o material de la cosa."),
      createConcept("14. ¿En qué consiste el saneamiento de la evicción?", "Consiste en amparar al comprador en el dominio y posesión pacífica. Comprende: 1ª etapa: obligación de hacer, defender al comprador contra terceros que reclaman derechos sobre la cosa. 2ª etapa (si fracasa): obligación de dar, indemnizar al comprador. Art. 1838: hay evicción cuando el comprador es privado del todo o parte de la cosa por sentencia judicial."),
      createConcept("15. ¿Qué son los vicios redhibitorios?", "Son los vicios o defectos que existiendo al tiempo de la venta y no siendo conocidos por el comprador, hacen que la cosa sea impropia para su uso natural o que solo sirva imperfectamente. Requisitos (Art. 1858): 1. El vicio debe haber existido al tiempo de la venta. 2. Debe ser grave. 3. Debe ser oculto. Dan derecho a la acción redhibitoria (resolución) o acción quanti minoris (rebaja de precio)."),
      createConcept("16. ¿Qué es el contrato de permuta?", "Art. 1897 CC: La permutación o cambio es un contrato en que las partes se obligan mutuamente a dar una especie o cuerpo cierto por otro."),
      createConcept("17. ¿Qué es la cesión de derechos?", "Es la transferencia de un derecho por acto entre vivos. El CC regula tres especies: A. Cesión de derechos personales. B. Cesión del derecho real de herencia. C. Cesión de derechos litigiosos."),
      createConcept("18. ¿En qué consiste la cesión de derechos personales?", "Es el traspaso o tradición por el cual una persona transfiere voluntariamente a otra los derechos personales que tiene contra un tercero. Intervinientes: Cedente (acreedor que transfiere), Cesionario (adquiere el derecho, pasando a ocupar el lugar del acreedor), Deudor (sujeto pasivo que queda obligado a favor del cesionario)."),
      createConcept("19. ¿Cómo se perfecciona la cesión de derechos personales?", "Entre cedente y cesionario: no tiene efecto sino en virtud de la entrega del título (Art. 1901). Respecto del deudor y terceros: no produce efecto mientras no ha sido notificada por el cesionario al deudor o aceptada por éste (Art. 1902). Si no hay notificación o aceptación se aplica el art. 1905."),
      createConcept("20. ¿Qué efectos produce la cesión de derechos personales?", "1. En cuanto a su extensión: Art. 1906 CC: la cesión comprende sus fianzas, privilegios e hipotecas, pero no traspasa las excepciones personales del cedente. 2. Nulidad relativa: pasa al cesionario la facultad de solicitarla. 3. Excepción de compensación (Art. 1659). 4. Responsabilidad: si fue a título gratuito, el cedente no responde; si es a título oneroso, solo responde de la existencia del crédito al momento de la cesión."),
      createConcept("21. ¿Qué es la cesión del derecho real de herencia?", "Es la transferencia que efectúa el heredero a un tercero, del todo o parte de sus derechos en la herencia, una vez producido el fallecimiento del causante. Regulada en los artículos 1909 y 1910 CC."),
      createConcept("22. ¿En qué consiste la cesión de derechos litigiosos?", "Art. 1911 CC: Se cede un derecho litigioso cuando el objeto directo de la cesión es el evento incierto de la litis, del que no se hace responsable el cedente. Se entiende litigioso un derecho desde que se notifica judicialmente la demanda."),
      createConcept("23. ¿Qué es el contrato de arrendamiento?", "Art. 1915 CC: Es un contrato en que las dos partes se obligan recíprocamente, la una a conceder el goce de una cosa, o a ejecutar una obra o prestar un servicio, y la otra a pagar por este goce, obra o servicio un precio determinado. Comprende: arrendamiento de cosa, confección de obra material, y prestación de servicio."),
      createConcept("24. ¿Cuáles son las características del contrato de arrendamiento?", "a. Contrato Principal. b. Consensual (salvo predios rústicos). c. Bilateral. d. De derecho estricto. e. Oneroso. f. Conmutativo. g. De tracto sucesivo. h. Título de mera tenencia."),
      createConcept("25. ¿Cuáles son los requisitos del contrato de arrendamiento de cosa?", "1. Consentimiento. 2. La cosa arrendada: debe ser real, determinada y susceptible de darse en arrendamiento. 3. El precio (renta): debe ser en dinero o frutos naturales (aparcería en predios rústicos), real y determinado."),
      createConcept("26. ¿Cómo se perfecciona el contrato de arrendamiento?", "Se perfecciona por el solo acuerdo de las partes, sin necesidad de solemnidad. Sin embargo: se limita la prueba de testigos (Art. 1709), puede convenirse solemnidad voluntaria (Art. 1921), es preferible reducirla a escritura pública e inscribirla en el CBR para efectos del Art. 1962. En predios urbanos, sin escritura se presume que la renta es la que declare el arrendatario (Ley 18.101, Art. 20)."),
      createConcept("27. ¿Cuáles son las obligaciones del arrendador?", "1. Entrega de la cosa arrendada. 2. Mantenerla en estado de servir para el fin arrendado. 3. Librar al arrendatario de toda turbación o embarazo. 4. Sanear los vicios redhibitorios. 5. Reembolsar las sumas destinadas a reparaciones que eran cargo del arrendador. 6. Restituir la suma de dinero por concepto de garantía."),
      createConcept("28. ¿Cuáles son las obligaciones del arrendatario?", "1. Pagar el precio o renta. 2. Usar la cosa según los términos del contrato. 3. Cuidar la cosa como un buen padre de familia. 4. Efectuar reparaciones locativas. 5. Restituir el bien una vez terminado el contrato."),
      createConcept("29. ¿Quién responde de las reparaciones locativas y necesarias?", "Reparaciones locativas (deterioros normales del goce): de cargo del arrendatario, salvo que provengan de caso fortuito o mala calidad de la cosa arrendada. Reparaciones necesarias (sin las cuales la cosa desaparece o no puede usarse): de cargo del arrendador, siempre que el arrendatario no las haya hecho necesarias por su culpa y haya dado aviso oportuno."),
      createConcept("30. ¿En qué casos el sucesor del arrendador está obligado a respetar el arriendo?", "Art. 1962 CC: 1. Todo aquel a quien se transfiere el derecho del arrendador por título lucrativo (gratuito). 2. A título oneroso, si el arrendamiento ha sido contraído por escritura pública; exceptuados los acreedores hipotecarios. 3. Los acreedores hipotecarios, si el arrendamiento fue otorgado por escritura pública inscrita en el CBR antes de la inscripción hipotecaria."),
      createConcept("31. ¿Qué es el desahucio?", "Es una manifestación unilateral de voluntad por la cual una de las partes da aviso anticipado a la otra de su voluntad de poner fin al contrato de arrendamiento. Puede ser judicial o extrajudicial. En la Ley 18.101 de predios urbanos, solo se puede poner término al contrato mediante desahucio judicial."),
      createConcept("32. ¿Qué es la tácita reconducción?", "Consiste en la renovación del contrato de arriendo por el hecho de retener el arrendatario la cosa con la aparente anuencia del arrendador. Por regla general no es aceptada (Art. 1956 inc. 1 y 2), pero se permite si: A. Se trate de un bien raíz. B. El arrendatario conserve la tenencia. C. El arrendatario con beneplácito del arrendador haya pagado la renta de tiempo subsiguiente a la terminación, o ambas partes hayan manifestado inequívocamente su intención de perseverar en el contrato."),
      createConcept("33. ¿Cómo se termina el contrato de arrendamiento de cosas?", "Art. 1950 CC: 1°. Por la destrucción total de la cosa arrendada. 2°. Por la expiración del tiempo estipulado. 3°. Por la extinción del derecho del arrendador. 4°. Por sentencia del juez en los casos que la ley ha previsto. Además, se aplican los modos generales de extinción de contratos."),
      createConcept("34. ¿Qué es el censo?", "Art. 2022 CC: Se constituye un censo cuando una persona contrae la obligación de pagar a otra un rédito anual, reconociendo el capital correspondiente, y gravando una finca suya con la responsabilidad del rédito y del capital. Este rédito se llama censo o canon; la persona que lo debe, censuario; y su acreedor, censualista."),
      createConcept("35. ¿Qué es el contrato de sociedad?", "Art. 2053 CC: La sociedad o compañía es un contrato en que dos o más personas estipulan poner algo en común con la mira de repartir entre sí los beneficios que de ello provengan. La sociedad forma una persona jurídica, distinta de los socios individualmente considerados."),
      createConcept("36. ¿Cuáles son las características del contrato de sociedad?", "a. Contrato Plurilateral. b. Oneroso. c. Conmutativo. d. Principal. e. Consensual. f. Intuito personae."),
      createConcept("37. ¿Cuáles son los elementos del contrato de sociedad?", "1. Aporte de los socios. 2. Participación en las utilidades. 3. Contribución a las pérdidas. 4. Affectio societatis."),
      createConcept("38. ¿Cuáles son las obligaciones de los socios?", "1. Efectuar el aporte. 2. Sanear la evicción del cuerpo cierto aportado. 3. Cuidar como un buen padre de familia los intereses sociales. 4. Prohibición de incorporar nuevos socios."),
      createConcept("39. ¿Cuáles son las causales de disolución de la sociedad?", "1. Expiración del plazo o evento de una condición (Art. 2098). 2. Finalización del negocio para que fue contraída (Art. 2099). 3. Insolvencia de la sociedad (Art. 2100). 4. Pérdida total de los bienes sociales (Art. 2100). 5. Incumplimiento de efectuar el aporte prometido (Art. 2101). 6. Muerte de un socio (Art. 2103). 7. Incapacidad sobreviniente de un socio (Art. 2106). 8. Insolvencia sobreviniente de un socio (Art. 2106). 9. Acuerdo unánime de los socios (Art. 2107). 10. Renuncia de un socio (Art. 2108)."),
      createConcept("40. ¿Qué es el contrato de mandato?", "Art. 2116 CC: El mandato es un contrato en que una persona confía la gestión de uno o más negocios a otra, que se hace cargo de ellos por cuenta y riesgo de la primera. El que confiere el encargo: comitente o mandante. El que acepta: apoderado, procurador o mandatario. El mandatario actúa por cuenta y riesgo del mandante (elemento de la esencia), quien aprovecha los beneficios y soporta las pérdidas."),
      createConcept("41. ¿Cuáles son las características del contrato de mandato?", "a. Generalmente consensual (salvo mandato judicial, mandato para contraer matrimonio). b. Naturalmente oneroso. c. En principio bilateral. d. Contrato principal. e. Contrato de confianza (intuito personae). f. Mandatario obra por cuenta y riesgo del mandante."),
      createConcept("42. ¿Cuáles son los requisitos del mandato?", "1. Que se confíe la ejecución de uno o más negocios jurídicos. 2. Que el mandato no interese solo al mandatario (Art. 2119: el negocio que interesa solo al mandatario es un mero consejo, sin obligación alguna). 3. Capacidad del mandante (reglas generales) y del mandatario (regla especial: puede ser menor adulto, Art. 2128)."),
      createConcept("43. ¿Cuál es la relación entre mandato y representación?", "La representación (Art. 1448) es un elemento de la naturaleza del mandato, no de la esencia, por lo que el mandatario puede actuar a nombre propio. Son instituciones distintas: la representación es una modalidad de los actos jurídicos; el mandato, un contrato. La representación puede originarse en convención, ley o sentencia; el mandato solo en convención. Puede existir mandato sin representación."),
      createConcept("44. ¿Cuáles son los efectos si el mandatario actúa a nombre propio (sin representación)?", "Art. 2151 CC: Si contrata a su propio nombre, no obliga respecto de terceros al mandante. Los efectos jurídicos del acto se radican en el patrimonio del mandatario, quien debe luego rendir cuenta: ceder los derechos adquiridos respecto de terceros, traspasar los bienes adquiridos para el mandante y las deudas contraídas a favor de terceros."),
      createConcept("45. ¿Cuáles son las obligaciones del mandatario y del mandante?", "Obligaciones del mandatario: 1. Cumplir el mandato según lo convenido. 2. Rendir cuenta. Obligaciones del mandante: 1. Proveer lo necesario para la ejecución. 2. Reembolsar gastos razonables. 3. Pagar la remuneración estipulada o usual. 4. Pagar las anticipaciones de dinero con intereses corrientes. 5. Indemnizar las pérdidas sufridas sin culpa del mandatario y por causa del mandato."),
      createConcept("46. ¿Se puede delegar el mandato?", "Art. 2135 CC: El mandatario puede delegar si no se le ha prohibido (elemento de la naturaleza). Los efectos dependen de si el mandante autoriza la delegación (con o sin indicación del delegado), la prohíbe expresamente, o nada dice. Regulado en los artículos 2135 a 2138 CC."),
      createConcept("47. ¿Cuándo termina el contrato de mandato?", "Art. 2163 CC: 1°. Por el desempeño del negocio para que fue constituido. 2°. Por expiración del término o evento de la condición. 3°. Por la revocación del mandante. 4°. Por la renuncia del mandatario. 5°. Por la muerte del mandante o del mandatario. 6°. Por tener la calidad de deudor en un procedimiento concursal de liquidación. 7°. Por la interdicción del uno o del otro. 8°. Por la cesación de las funciones del mandante, si el mandato fue dado en ejercicio de ellas."),
      createConcept("48. ¿Qué es el contrato de transacción?", "Art. 2446 CC: Es un contrato en que las partes terminan extrajudicialmente un litigio pendiente, o precaven un litigio eventual. La doctrina agrega: haciéndose las partes sacrificios o concesiones recíprocas. No es transacción el acto que solo consiste en la renuncia de un derecho que no se disputa."),
      createConcept("49. ¿Cuáles son las características del contrato de transacción?", "a. Consensual. b. Bilateral. c. Oneroso. d. Equivalente jurisdiccional. e. Generalmente conmutativo. f. Principal. g. Puede ser título traslaticio de dominio y también declarativo. h. Intuito personae."),
      createConcept("50. ¿Cuáles son los elementos del contrato de transacción?", "A. Existencia de un derecho dudoso. B. Concesiones recíprocas. C. Capacidad para transigir."),
      createConcept("51. ¿Qué es el contrato de comodato?", "Art. 2174 CC: El comodato o préstamo de uso es un contrato en que una de las partes entrega a la otra gratuitamente una especie, mueble o raíz, para que haga uso de ella, y con cargo de restituir la misma especie después de terminado el uso. No se perfecciona sino por la tradición de la cosa (entendida como simple entrega, no como modo de adquirir el dominio, pues es título de mera tenencia)."),
      createConcept("52. ¿Cuáles son las características del contrato de comodato?", "a. Real. b. Esencialmente gratuito. c. Unilateral. d. Principal. e. Título de mera tenencia."),
      createConcept("53. ¿Cuáles son las obligaciones del comodatario?", "1. Conservar la cosa. 2. Usar la cosa en los términos convenidos. 3. Restituir la cosa."),
      createConcept("54. ¿Cuáles son las obligaciones del comodante?", "Si bien el comodato es unilateral, pueden surgir obligaciones eventuales para el comodante (contrato sinalagmático imperfecto): 1. Pagar las expensas de conservación de la cosa. 2. Indemnizar los perjuicios que le haya causado al comodatario la mala calidad o condición de la cosa."),
      createConcept("55. ¿Qué es el comodato precario y el simple precario?", "Comodato precario (Art. 2194): El comodante se reserva la facultad de pedir la restitución en cualquier tiempo. Simple precario (Art. 2195): No se presta la cosa para un servicio particular ni se fija tiempo para su restitución. También constituye precario la tenencia de una cosa ajena sin previo contrato y por ignorancia o mera tolerancia del dueño."),
      createConcept("56. ¿Qué es el contrato de mutuo?", "Art. 2196 CC: El mutuo o préstamo de consumo es un contrato en que una de las partes entrega a la otra cierta cantidad de cosas fungibles con cargo de restituir otras tantas del mismo género y calidad."),
      createConcept("57. ¿Cuáles son las características del contrato de mutuo?", "a. Real. b. Unilateral. c. Naturalmente gratuito. d. Principal. e. Título traslaticio de dominio. f. El objeto consiste en cosas fungibles que no sean dinero."),
      createConcept("58. ¿Qué es una operación de crédito de dinero?", "Art. 1° Ley 18.010: Son aquellas por las cuales una de las partes entrega o se obliga a entregar una cantidad de dinero y la otra a pagarla en un momento distinto de aquél en que se celebra la convención. Constituye también operación de crédito de dinero el descuento de documentos representativos de dinero."),
      createConcept("59. ¿Cuáles son las características de la operación de crédito de dinero?", "a. Puede ser real o consensual. b. Puede ser unilateral o bilateral. c. Naturalmente oneroso. d. Principal. e. Título traslaticio de dominio. f. El objeto consiste en una suma de dinero."),
      createConcept("60. ¿Cuáles son las obligaciones del mutuario?", "Art. 2198 CC: Restituir igual cantidad de cosas del mismo género y calidad; si no fuere posible, podrá pagar lo que valgan en el tiempo y lugar en que ha debido hacerse el pago. También estará obligado a pagar intereses si se pactaron. En operaciones de crédito de dinero (Ley 18.010), se obliga a restituir la suma de dinero."),
      createConcept("61. ¿En qué momento se debe hacer la restitución en el mutuo?", "Mutuo de cosas fungibles: en la época estipulada. Si no se fijó término, no habrá derecho de exigirlo dentro de los 10 días subsiguientes a la entrega (Art. 2200). Si se pactó que pagará cuando le sea posible, el juez fijará el plazo (Art. 2201). Operación de crédito de dinero: solo podrá exigirse el pago después de los 10 días contados desde la entrega (Art. 13 Ley 18.010)."),
      createConcept("62. ¿Se puede anticipar el pago en el mutuo?", "Mutuo de cosas fungibles: Art. 2204 CC: el mutuario puede pagar toda la suma prestada aun antes del término estipulado, salvo que se hayan pactado intereses. Operación de crédito de dinero: el derecho a pagar anticipadamente es irrenunciable, conforme al Art. 10 Ley 18.010."),
      createConcept("63. ¿Qué es el anatocismo?", "Es el interés calculado sobre interés. Antiguamente prohibido por el Art. 2210 CC, hoy está expresamente autorizado por el Art. 9° Ley 18.010: podrá estipularse el pago de intereses sobre intereses, capitalizándolos en cada vencimiento o renovación. En ningún caso la capitalización podrá hacerse por períodos inferiores a treinta días."),
      createConcept("64. ¿Qué es el contrato de depósito?", "Art. 2211 CC: Llámase en general depósito el contrato en que se confía una cosa corporal a una persona que se encarga de guardarla y de restituirla en especie. La cosa depositada se llama también depósito."),
      createConcept("65. ¿Cuáles son las características del contrato de depósito?", "a. Real. b. Unilateral. c. Esencialmente gratuito. d. Principal. e. Intuito personae. f. Título de mera tenencia."),
      createConcept("66. ¿Cómo se clasifica el depósito?", "A. Regular: puede ser propiamente dicho (voluntario o necesario) o secuestro (convencional o judicial). B. Irregular."),
      createConcept("67. ¿En qué consiste el contrato de depósito voluntario?", "Art. 2215 CC: Es un contrato en que una de las partes entrega a la otra una cosa corporal y mueble para que la guarde y la restituya en especie a voluntad del depositante. Obligaciones del depositario: 1. Guardar la cosa con la debida fidelidad. 2. Restituir la cosa a requerimiento del depositante."),
      createConcept("68. ¿Qué es el depósito necesario?", "Art. 2236 CC: El depósito propiamente dicho se llama necesario cuando la elección de depositario no depende de la libre voluntad del depositante, como en el caso de un incendio, ruina, saqueo u otra calamidad semejante."),
      createConcept("69. ¿Qué es el secuestro?", "Art. 2249 CC: El secuestro es el depósito de una cosa que se disputan dos o más individuos, en manos de otro que debe restituirla al que obtenga una decisión a su favor. El depositario se llama secuestre."),
      createConcept("70. ¿Qué es el depósito irregular?", "Art. 2221 CC: En el depósito de dinero, si no es en arca cerrada cuya llave tiene el depositante, o con otras precauciones que hagan imposible tomarlo sin fractura, se presumirá que se permite emplearlo, y el depositario será obligado a restituir otro tanto en la misma moneda."),
      createConcept("71. ¿Qué es el contrato de fianza?", "Art. 2335 CC: La fianza es una obligación accesoria, en virtud de la cual una o más personas responden de una obligación ajena, comprometiéndose para con el acreedor a cumplirla en todo o parte, si el deudor principal no la cumple. La fianza puede constituirse no solo a favor del deudor principal, sino de otro fiador."),
      createConcept("72. ¿Cuáles son las características del contrato de fianza?", "a. Consensual. b. Unilateral. c. Gratuito. d. Accesorio. e. Pura y simple, pero admite modalidades. f. Admite subcontratación. g. Transmisible. h. Fiador responde de culpa leve."),
      createConcept("73. ¿Cuáles son los efectos de la fianza entre acreedor y fiador?", "Antes que el acreedor demande al fiador: A. Derecho del fiador de anticipar el pago de la deuda. B. Derecho del fiador de exigir al acreedor que proceda contra el deudor. Efectos posteriores al requerimiento: A. Beneficio de excusión. B. Beneficio de división. C. Excepción de subrogación. D. Excepciones reales y personales."),
      createConcept("74. ¿Qué es el beneficio de excusión?", "Art. 2357 CC: El fiador reconvenido puede exigir que antes de proceder contra él se persiga la deuda en los bienes del deudor principal, y en las hipotecas o prendas prestadas por éste para la seguridad de la misma deuda. Para hacerse valer, debe cumplir con los requisitos del artículo 2358 CC."),
      createConcept("75. ¿Qué acciones tiene el fiador en contra del deudor?", "Una vez realizado el pago, el fiador tiene: Acción de reembolso o personal: emana del contrato de fianza, permite al fiador quedar totalmente indemne; comprende capital pagado, intereses, gastos y perjuicios. Acción subrogatoria: opera por el ministerio de la ley (Art. 1610 n°3), respecto del que paga una deuda a que se halla obligado subsidiariamente, pasando a ocupar el lugar del acreedor y gozar de sus garantías."),
      createConcept("76. ¿Qué es el contrato de prenda?", "Art. 2384 CC: Por el contrato de empeño o prenda se entrega una cosa mueble a un acreedor para la seguridad de su crédito. La cosa entregada se llama prenda. El acreedor que la tiene se llama acreedor prendario."),
      createConcept("77. ¿Cuáles son las características de la prenda?", "Características del contrato: a. Real (en prendas especiales es solemne). b. Unilateral. c. Accesorio. d. Título de mera tenencia. e. Regla general oneroso. Características del derecho de prenda: a. Derecho real (Art. 577). b. Derecho mueble (Art. 580). c. Concede privilegio de segunda clase. d. Indivisible (Art. 2405). e. Accesorio."),
      createConcept("78. ¿Cuáles son los derechos del acreedor prendario?", "1. Derecho de retención. 2. Derecho de persecución. 3. Derecho de realización o venta. 4. Derecho de preferencia. 5. Derecho de ser indemnizado."),
      createConcept("79. ¿En qué consiste el derecho de retención del acreedor prendario?", "Consiste en conservar la prenda hasta el pago total de la obligación (solo opera en prendas con desplazamiento). Comprende: la totalidad de la deuda en capital e intereses, gastos necesarios para conservar la prenda, y perjuicios ocasionados por la tenencia. Excepciones: el acreedor puede estar obligado a restituir si el deudor solicita reemplazo de la prenda o si el acreedor hace uso indebido de ella. Existe también la prenda tácita que permite retener aún pagado el crédito."),
      createConcept("80. ¿Qué es la prenda tácita?", "Art. 2401 CC: Aun satisfecho el crédito en todas sus partes, el acreedor puede retener la prenda si tuviera contra el mismo deudor otros créditos que: 1. Sean ciertos y líquidos. 2. Se hayan contraído después que la obligación para la cual se constituyó la prenda. 3. Se hayan hecho exigibles antes del pago de la obligación anterior. No procede cuando el acreedor haya perdido la tenencia de la prenda (Art. 2393) ni cuando el deudor vende la cosa empeñada o constituye un derecho (Art. 2404)."),
      createConcept("81. ¿Cuáles son las obligaciones del acreedor prendario?", "1. Restituir la cosa. 2. Cuidar y conservar la cosa como un buen padre de familia. 3. No puede usar la cosa."),
      createConcept("82. ¿Cómo se extingue la prenda?", "Art. 2406 CC. Por vía consecuencial: extinguida la obligación principal se extingue la prenda (lo accesorio sigue la suerte de lo principal). Por vía principal o directa: A. Destrucción total de la prenda. B. Cuando la propiedad de la cosa pasa al acreedor por cualquier título. C. Resolución del derecho del constituyente. D. Abuso de la prenda por el acreedor."),
      createConcept("83. ¿Qué es el contrato de hipoteca?", "Definición legal (Art. 2407 CC): La hipoteca es un derecho de prenda constituido sobre inmuebles que no dejan por eso de permanecer en poder del deudor. Definición doctrinaria (Somarriva): Derecho real que grava a un inmueble, que no deja de permanecer en poder del constituyente, destinado a asegurar el cumplimiento de una obligación principal, otorgando al acreedor la facultad de perseguir la finca en manos de quien se encuentre y pagarse preferentemente con el producto de su realización."),
      createConcept("84. ¿Cuáles son las características de la hipoteca?", "Características del contrato: a. Unilateral. b. Accesorio. c. Puede ser gratuito u oneroso. d. Solemne (Arts. 2409 y 2410). Características del derecho: a. Derecho real (Art. 577). b. Derecho inmueble (Art. 580). c. La cosa hipotecada permanece en poder del deudor. d. Concede preferencia de tercera clase. e. Indivisible (Art. 2408). f. Accesorio."),
      createConcept("85. ¿Cuáles son los efectos de la hipoteca en relación al inmueble hipotecado?", "La hipoteca se extiende a: A. El bien hipotecado (inmueble por naturaleza). B. Inmuebles por destinación (Art. 2420). C. Aumentos y mejoras que reciba la cosa hipotecada (Art. 2421). D. Rentas de arrendamiento e indemnizaciones de aseguradoras del bien (Art. 2422). E. Precio de la expropiación del inmueble (Art. 924 CPC)."),
      ...
      createConcept("100. ¿Qué es la comunidad?", "La comunidad es un cuasicontrato en virtud del cual los que poseen en común una cosa universal o singular, sin que ninguno de ellos haya contratado sociedad o celebrado otra convención relativa a la misma cosa, contraen ciertas obligaciones recíprocas."),
    ],
  },
  {
    ...createModule("Contratos General"),
    concepts: [
      createConcept("1. ¿Cuál es la definición legal de contrato?", "Art. 1438 CC: Contrato o convención es un acto por el cual una parte se obliga para con otra a dar, hacer o no hacer alguna cosa. Cada parte puede ser una o muchas personas."),
      createConcept("2. ¿Cuáles son las críticas a la definición legal de contrato?", "Se emplea como sinónimo contrato y convención (la convención es el género — acto jurídico bilateral destinado a crear, modificar o extinguir derechos y obligaciones —, el contrato es la especie, destinada únicamente a crear derechos y obligaciones). Se confunde el objeto del contrato con el objeto de la obligación (el primero corresponde a las obligaciones que crea; el objeto de la obligación es la prestación de dar, hacer o no hacer)."),
      createConcept("3. ¿Cuál es la definición doctrinaria de contrato?", "El contrato es un acto jurídico bilateral que crea derechos y obligaciones."),
      createConcept("4. ¿Cuáles son los elementos del contrato?", "Art. 1444 CC: cosas de la esencia, de la naturaleza y puramente accidentales."),
      createConcept("5. ¿Ejemplos de elementos de la esencia?", "Compraventa: el precio debe ser en dinero; si no, degenera en permuta, y si falta el precio, degenera en donación. Depósito: la gratuidad es esencial; si se pacta remuneración, degenera en arrendamiento de servicios (Art. 2219). Comodato: esencialmente gratuito; si se pacta precio, degenera en arrendamiento."),
      createConcept("6. ¿Ejemplos de elementos de la naturaleza?", "Compraventa: obligación de saneamiento (evicción y vicios redhibitorios). Mandato: delegación, representación y remuneración. Contratos bilaterales: condición resolutoria tácita."),
      createConcept("7. ¿Ejemplos de elementos accidentales?", "En general corresponden a las modalidades (plazo, condición o modo), como el pacto comisorio, pacto de retroventa y pacto de retracto en la compraventa."),
      createConcept("8. ¿Cuáles son las funciones del contrato?", "Función económica: principal vehículo de las relaciones económicas, circulación de la riqueza e intercambio de bienes y servicios. Función social: medio de colaboración entre los hombres, relacionada directamente con el principio de buena fe."),
      createConcept("9. ¿Cuáles son las subfunciones del contrato?", "Función de cambio (títulos traslaticios de dominio). Función de crédito (mutuo, contratos bancarios). Función de garantía (prenda, hipoteca, fianza). Función de custodia (depósito). Función laboral (trabajo, arrendamiento de servicios, mandato). Función de previsión (seguro). Función de recreación (transporte turístico, hotelería). Función de cooperación (actos intuito personae). Función de uso y goce (arrendamiento)."),
      createConcept("10. ¿Cómo se clasifican los contratos en el Código Civil?", "Unilateral y bilateral. Gratuito y oneroso. Conmutativo o aleatorio. Principal o accesorio. Real, solemne o consensual."),
      createConcept("11. ¿Qué es un contrato unilateral y bilateral?", "Art. 1439 CC: unilateral cuando una de las partes se obliga para con otra que no contrae obligación alguna; bilateral cuando las partes contratantes se obligan recíprocamente."),
      createConcept("12. ¿Cómo se subclasifica el contrato bilateral?", "Sinalagmático perfecto: todas las obligaciones surgen al perfeccionarse el contrato y son interdependientes entre sí. Sinalagmático imperfecto: nace como unilateral, pero con posterioridad surgen obligaciones para la parte que originalmente no se encontraba obligada."),
      createConcept("13. ¿En qué consisten los contratos plurilaterales?", "Son aquellos que provienen de la manifestación de voluntad de dos o más partes, todas las cuales resultan obligadas en vistas de un objetivo común. Ej.: contrato de sociedad, donde todos los socios se obligan a efectuar un aporte y a soportar las eventuales pérdidas."),
      createConcept("14. ¿Cuáles son las diferencias entre contratos plurilaterales y bilaterales?", "Derechos y obligaciones: en los bilaterales surgen obligaciones correlativas; en los plurilaterales cada parte adquiere derechos y obligaciones respecto a todos los demás. Vicios del consentimiento: en los bilaterales un vicio implica la nulidad del acto; en los plurilaterales solo genera ineficacia del concurso de ese contratante, siendo válido respecto de los demás. Ingreso de nuevas partes: los bilaterales están limitados a quienes concurrieron a la celebración; los plurilaterales admiten ingreso y retiro de partes. Extinción: los bilaterales tienen corta duración; los plurilaterales tienen por objeto perdurar en el tiempo."),
      createConcept("15. ¿Ejemplos de contrato unilateral y bilateral?", "Unilateral: comodato, mutuo, donación, depósito. Bilateral: compraventa, arrendamiento, mandato, permuta."),
      createConcept("16. ¿Cuál es la importancia de distinguir entre contrato unilateral y bilateral?", "Ciertas instituciones solo son aplicables al contrato bilateral: condición resolutoria tácita (Art. 1489), teoría de los riesgos (Art. 1550), excepción de contrato no cumplido (Art. 1552) y revisión del contrato."),
      createConcept("17. ¿Qué es un contrato gratuito y oneroso?", "Art. 1440 CC: gratuito cuando solo tiene por objeto la utilidad de una de las partes, sufriendo la otra el gravamen; oneroso cuando tiene por objeto la utilidad de ambos contratantes, gravándose cada uno a beneficio del otro."),
      createConcept("18. ¿Ejemplos de contrato gratuito y oneroso?", "Gratuito: donación, depósito, mutuo sin interés. Oneroso: compraventa, arrendamiento, permuta, sociedad, mutuo con interés."),
      createConcept("19. ¿Cuál es la importancia de distinguir entre contrato gratuito y oneroso?", "Determinar el grado de culpa del deudor. La obligación de saneamiento de la evicción es propia de los contratos onerosos. Los gratuitos son generalmente intuito personae. Los gratuitos imponen deber de reconocimiento y lealtad. Requisitos de la acción pauliana. Casos en que se respeta el contrato de arrendamiento por terceros. Reivindicación en el cuasicontrato de pago de lo no debido. Restricción de ciertos contratos gratuitos (insinuación en donación). En los gratuitos la pura liberalidad es causa suficiente."),
      createConcept("20. ¿Qué es un contrato conmutativo y aleatorio?", "Art. 1441 CC: oneroso es conmutativo cuando cada una de las partes se obliga a dar o hacer una cosa que se mira como equivalente a lo que la otra parte debe dar o hacer a su vez; y si el equivalente consiste en una contingencia incierta de ganancia o pérdida, se llama aleatorio."),
      createConcept("21. ¿Ejemplos de contrato conmutativo y aleatorio?", "Conmutativo: compraventa, arrendamiento, permuta, mutuo con interés. Aleatorio: renta vitalicia, el juego, la apuesta, el seguro, venta de derechos litigiosos."),
      createConcept("22. ¿Cuál es la importancia de distinguir entre contrato conmutativo y aleatorio?", "En los contratos conmutativos son aplicables dos instituciones: la lesión enorme (en los casos expresamente señalados) y la teoría de la imprevisión."),
      createConcept("23. ¿Qué es un contrato principal y accesorio?", "Art. 1442 CC: principal cuando subsiste por sí mismo sin necesidad de otra convención; accesorio cuando tiene por objeto asegurar el cumplimiento de una obligación principal, de manera que no pueda subsistir sin ella."),
      createConcept("24. ¿Ejemplos de contrato principal y accesorio?", "Principal: promesa, compraventa, arrendamiento, transacción, depósito, mandato, comodato. Accesorios: hipoteca, prenda, fianza, anticresis."),
      createConcept("25. ¿Importancia de distinguir entre contrato principal y accesorio?", "Permite determinar la aplicación del principio 'lo accesorio sigue la suerte de lo principal', es decir, la extinción del contrato accesorio por consecuencia del principal. Dos alcances: a) hay casos en que extinguido el principal subsisten los accesorios (ej. reserva de cauciones al operar una novación); b) excepcionalmente el accesorio puede influir en el principal (ej. inmueble hipotecado que se deteriora: el acreedor puede exigir otra garantía o el pago inmediato de la deuda líquida)."),
      createConcept("26. ¿Qué es un contrato real, solemne y consensual?", "Art. 1443 CC: real cuando para que sea perfecto es necesaria la tradición de la cosa a que se refiere; solemne cuando está sujeto a la observancia de ciertas formalidades especiales, de manera que sin ellas no produce ningún efecto civil; consensual cuando se perfecciona por el solo consentimiento."),
      createConcept("27. ¿Ejemplos de contrato real, solemne y consensual?", "Real: comodato, depósito, mutuo, prenda civil. Solemne: compraventa de bien raíz, matrimonio, promesa. Consensual: compraventa de bien mueble, arrendamiento, mandato, sociedad civil."),
      createConcept("28. ¿Cómo se clasifican los contratos en la doctrina?", "Nominados/típicos o innominados/atípicos. Ejecución instantánea, ejecución diferida, tracto sucesivo o duración indefinida. Individuales o colectivos. Preparatorios o definitivos. Libre discusión o adhesión."),
      createConcept("29. ¿Cuáles son los contratos nominados o innominados?", "Los contratos nominados o típicos son aquellos expresamente reglamentados por el legislador en códigos o leyes especiales. Los innominados o atípicos son los que no lo han sido."),
      createConcept("30. ¿Cuáles son los contratos de ejecución instantánea, diferida, tracto sucesivo o duración indefinida?", "Ejecución instantánea: las obligaciones se cumplen apenas se celebra el contrato; nace y se extingue simultáneamente. Ejecución diferida: todas o algunas obligaciones se cumplen en cierto plazo. Tracto sucesivo: el cumplimiento se escalone en el tiempo durante un lapso prolongado; la relación contractual tiene permanencia. Duración indefinida: nacen sin plazo expreso o tácito de vigencia, con pretensión de prolongarse en el tiempo."),
      createConcept("31. ¿Cuáles son los contratos individuales o colectivos?", "Individuales: requieren el consentimiento unánime de las partes jurídicamente vinculadas. Colectivos: crean obligaciones para personas que no concurrieron a su celebración, que no consintieron o que incluso se opusieron a la conclusión del contrato."),
      createConcept("32. ¿Qué es un contrato preparatorio o definitivo?", "Preparatorio o preliminar: aquel mediante el cual las partes estipulan que en el futuro celebrarán otro contrato que por ahora no pueden concluir o está sujeto a incertidumbre. Definitivo: el que se celebra cumpliendo con la obligación (de hacer) generada por el contrato preparatorio, suscribiendo el futuro contrato dentro de un plazo o al cumplirse una condición."),
      createConcept("33. ¿Qué es un contrato de libre discusión o de adhesión?", "Libre discusión: las partes han deliberado en cuanto a su contenido, examinando atentamente las cláusulas; es resultado de las negociaciones preliminares. Adhesión: las cláusulas son dictadas o redactadas por una sola de las partes; la otra se limita a aceptarlas en bloque, adhiriendo a ellas."),
      createConcept("34. ¿Qué son las categorías contractuales?", "Son ciertas figuras que pueden presentarse en toda clase de contratos, sin importar su clase. Afectan o alteran algunos de los principios generales de la contratación o inciden en ellos."),
      createConcept("35. ¿Cuáles son las categorías contractuales?", "A. Contrato dirigido. B. Contrato forzoso. C. Contrato tipo o condiciones generales de contratación. D. Contrato ley. E. Subcontrato. F. Autocontrato. G. Contrato por persona a nombrar. H. Contrato por cuenta de quién corresponda."),
      createConcept("36. ¿Qué es un contrato dirigido?", "Son aquellos en que la reglamentación legal asume carácter imperativo, sin que las partes puedan alterar lo señalado por el legislador en su contenido, efectos o en relación con la persona con quien se debe contratar. Ejemplos según contenido: contrato de trabajo, matrimonio, arrendamiento de predios urbanos. Según persona: Art. 25 Ley de Sociedades Anónimas y Art. 10 Código de Minería."),
      createConcept("37. ¿Qué es un contrato forzoso?", "Aquel que el legislador obliga a celebrar o a dar por celebrado (Jorge López Santa María). Contrato forzoso ortodoxo: se forma en dos etapas; primero un mandato de la autoridad que exige contratar, luego quien lo recibió celebra el contrato pudiendo elegir contraparte y discutir cláusulas (hay autonomía de la voluntad en la segunda etapa). Contrato forzoso heterodoxo: pérdida completa de la libertad contractual; el vínculo jurídico, las partes y el contenido vienen determinados por el poder público."),
      createConcept("38. ¿Qué es un contrato tipo?", "Acuerdo de voluntades en cuya virtud las partes predisponen o anticipan las cláusulas de futuros contratos que se celebrarán masivamente (Jorge López Santa María). También llamado 'condiciones generales de contratación'. Las partes adoptan un formulario o modelo que será reproducido sin alteraciones importantes en diversos casos posteriores, equivaliendo cada uno a un contrato prerredactado."),
      createConcept("39. ¿Qué es un contrato ley?", "Aquel por el cual el Estado garantiza que en el futuro no modificará ni derogará las franquicias contractuales vigentes. Tiene su origen en una oferta del Estado a los particulares para aprovechar ciertas franquicias o beneficios, con el propósito de fomentar el ahorro, el desarrollo de ciertas actividades productivas o alcanzar metas económicas o sociales. Constituye un estatuto jurídico de excepción."),
      createConcept("40. ¿Qué es el subcontrato?", "Nuevo contrato derivado y dependiente de otro contrato previo de la misma naturaleza (Jorge López Santa María). Ejemplos: subarrendamiento, delegación en el mandato, formación de sociedad particular con un tercero usando la parte social de un socio, subfianza."),
      createConcept("41. ¿Qué es el autocontrato?", "Acto jurídico que una persona celebra consigo misma, sin que sea menester la concurrencia de otra, actuando a la vez como parte directa y representante de la otra parte; o como representante de ambas partes; o como titular de dos patrimonios (o dos fracciones de un mismo patrimonio) sometidos a regímenes jurídicos diferentes (Jorge López Santa María)."),
      createConcept("42. ¿Qué es el contrato por persona a nombrar y por cuenta de quien corresponda?", "Por persona a nombrar: una de las partes se reserva la facultad de designar, mediante declaración posterior, a la persona que adquirirá retroactivamente los derechos y obligaciones radicadas en su patrimonio desde el principio. Por cuenta de quien corresponda: una de las partes inicialmente queda indeterminada o en blanco, en la seguridad que después será especificada."),
      createConcept("43. ¿Cuáles son los principios fundamentales de la contratación?", "1. Autonomía de la voluntad, con sus subprincipios: A. Consensualismo. B. Libertad contractual. C. Fuerza obligatoria de los contratos. D. Efecto relativo de los contratos. 2. Buena fe (independiente de la autonomía de la voluntad, no es propiamente un subprincipios)."),
      createConcept("44. ¿En qué consiste el principio de autonomía de la voluntad?", "La libertad de que gozan los particulares para pactar los contratos que les plazcan, y de determinar su contenido, efectos y duración (Alessandri). Doctrinariamente: es una doctrina de filosofía jurídica según la cual toda obligación reposa esencialmente sobre la voluntad de las partes, siendo ésta a la vez la fuente y la medida de los derechos y obligaciones que el contrato produce (López Santa María)."),
      createConcept("45. ¿En qué consiste el principio de consensualismo?", "Principio encaminado a determinar si los contratos surgen por la sola manifestación de voluntad (pactos desnudos) o requieren formalidades externas (pactos vestidos). Contratos consensuales propiamente tales: corresponden a la concepción moderna de contrato (ej. compraventa de bien mueble). Contratos consensuales formales: siendo consensuales, requieren ciertas formalidades para producir sus efectos (ej. Art. 9 Código del Trabajo o Art. 20 Ley 18.101)."),
      createConcept("46. ¿Cuáles son las excepciones y atenuantes del consensualismo?", "Excepciones: A. Contratos reales. B. Contratos solemnes. Atenuantes: A. Formalidades habilitantes. B. Formalidades de publicidad. C. Formalidades de prueba. D. Formalidades convencionales."),
      createConcept("47. ¿En qué consiste el principio de libertad contractual?", "Comprende la libertad de conclusión (las partes son libres para contratar o no, y para elegir al co-contratante) y la libertad de configuración (las partes pueden debatir y fijar el contenido de los contratos). Constituyen un deterioro a este principio los contratos dirigidos y los contratos forzosos."),
      createConcept("48. ¿En qué consiste la fuerza obligatoria de los contratos?", "Principio expresado en el aforismo 'pacta sunt servanda': los contratos deben cumplirse estrictamente. Art. 1545 CC: todo contrato legalmente celebrado es una ley para los contratantes, y no puede ser invalidado sino por su consentimiento mutuo o por causas legales. Existen múltiples diferencias entre el contrato y la ley en cuanto a su aplicación, formación, permanencia en el tiempo, forma de dejarlas sin efecto e interpretación."),
      createConcept("49. ¿Qué ocurre con la fuerza obligatoria de los contratos frente al legislador?", "La obligatoriedad del contrato se traduce en su intangibilidad: el contrato válidamente celebrado no puede ser modificado ni por el legislador ni por el juez. Sin embargo, esta intangibilidad es relativa, ya que en ciertos casos el legislador vulnera la fuerza obligatoria: leyes de emergencia (leyes moratorias que conceden facilidades de pago), normas permanentes (ej. Arts. 1879, 2180 CC) y leyes especiales que modifican contratos en curso."),
      createConcept("50. ¿Cuándo termina un contrato o se agota su fuerza obligatoria?", "Terminación normal: cuando se cumplen totalmente las obligaciones (pago u otro modo de extinción equivalente), por vencimiento del plazo estipulado, o por desahucio de una de las partes (tiempo indefinido). Terminación anormal o invalidación (Art. 1545): por consentimiento mutuo de las partes (resciliación) o por causas legales (nulidad absoluta o relativa, resolución, revocación, entre otras)."),
      createConcept("51. ¿Es procedente el recurso de casación en el fondo por infracción de ley del contrato?", "Se ha discutido si la 'ley del contrato' queda comprendida en el concepto de infracción de ley que habilita el recurso de casación en el fondo. Se ha señalado que sí es posible, argumentando que la obligatoriedad del contrato para las partes y para el juez es suficiente para concluir que su violación autoriza el recurso, considerándose también el principio de libertad contractual y la historia fidedigna del artículo 767 CPC."),
      createConcept("52. ¿En qué consiste el principio de efecto relativo de los contratos?", "Aquel mediante el cual los contratos solo generan derechos y obligaciones para las partes contratantes que concurren a su celebración, sin beneficiar ni perjudicar a terceros. Si bien no tiene consagración expresa, se puede colegir del artículo 1545 CC, que señala que todo contrato legalmente celebrado es una ley 'para los contratantes'."),
      createConcept("53. ¿Qué sujetos se pueden diferenciar en el principio de efecto relativo?", "Partes: quienes concurren a la celebración del contrato, personalmente o a través de representante legal o convencional. Terceros absolutos: extraños al contrato que no han tenido participación alguna ni están vinculados con las partes. Terceros relativos: quienes con posterioridad a la celebración se encuentran en relación jurídica con alguna de las partes, sea por su propia voluntad o disposición de la ley. Pueden ser causahabientes a título singular (suceden en un bien específicamente determinado) o acreedores de las partes (alcanzados indirectamente por el efecto expansivo del contrato)."),
      createConcept("54. ¿Cuáles son las excepciones al efecto relativo de los contratos?", "Son excepciones al principio de efecto relativo: A. Contratos colectivos. B. Estipulación en favor de otro. C. Promesa de hecho ajeno."),
      createConcept("55. ¿En qué consiste la estipulación a favor de otro?", "Art. 1449 CC: cualquiera puede estipular a favor de una tercera persona, aunque no tenga derecho para representarla; pero solo esta tercera persona podrá demandar lo estipulado; y mientras no intervenga su aceptación expresa o tácita, es revocable el contrato por la sola voluntad de las partes que concurrieron a él. Constituyen aceptación tácita los actos que solo hubieran podido ejecutarse en virtud del contrato. Ejemplo típico: el contrato de seguro."),
      createConcept("56. ¿Cuáles son las teorías sobre la naturaleza jurídica de la estipulación a favor de otro?", "A. Teoría de la oferta. B. Teoría de la gestión de negocios ajenos. C. Teoría de la declaración unilateral de voluntad. D. Teoría de la adquisición directa del derecho."),
      createConcept("57. ¿Quiénes intervienen en la estipulación a favor de otro?", "Estipulante: quien estipula a favor de otro. Promitente: quien contrae la obligación. Tercero beneficiario: quien no ha intervenido y en cuyo favor nace el derecho del referido contrato."),
      createConcept("58. ¿Cuáles son los efectos de la estipulación a favor de otro?", "Entre estipulante y promitente: son las partes del contrato; el estipulante no puede pedir el cumplimiento forzado (corresponde al tercero); pueden revocar el contrato mientras no haya aceptación del beneficiario. Entre promitente y beneficiario: el promitente queda directamente obligado frente al beneficiario; este es acreedor desde la celebración y tiene acción de cumplimiento forzado e indemnización desde la aceptación; no tiene acción resolutoria; si fallece antes de aceptar, transmite la facultad de aceptar. Entre estipulante y beneficiario: son jurídicamente extraños."),
      createConcept("59. ¿En qué consiste la promesa de hecho ajeno?", "Art. 1450 CC: cuando uno de los contratantes se compromete a que por una tercera persona, de quien no es legítimo representante, ha de darse, hacerse o no hacerse alguna cosa, esta tercera persona no contraerá obligación alguna sino en virtud de su ratificación; y si no ratifica, el otro contratante tendrá acción de perjuicios contra el que hizo la promesa. No es propiamente una excepción al efecto relativo, porque la convención no crea derechos ni obligaciones respecto del tercero; el único obligado es el promitente."),
      createConcept("60. ¿Quiénes intervienen en la promesa de hecho ajeno?", "Promitente: quien hizo la promesa y contrae la obligación de hacer que otro acepte. Prometido: es el acreedor. Tercero: la persona que asumirá la obligación una vez ratifique lo obrado por el promitente."),
      ...
      createConcept("86. ¿En qué consisten las reglas de interpretación de los contratos?", "Son los principios y moldes que sirven de base a los razonamientos del intérprete, y que le ayudan en la búsqueda de la intención común de los contratantes (Jorge López Santa María)."),
      ...
      createConcept("88. ¿Cuál es el principio rector en materia de interpretación?", "Art. 1560 CC: conocida claramente la intención de los contratantes, debe estarse a ella más que a lo literal de las palabras."),
      createConcept("89. ¿Cuáles son las reglas de interpretación relativas a los elementos intrínsecos del contrato?", "Se interpreta el texto del contrato por sí mismo sin recurrir a elementos extraños. a. Regla de la armonía o elemento sistemático (Art. 1564 CC). b. Regla de la utilidad de las cláusulas (Art. 1562 CC). c. Regla del sentido natural (Art. 1563 inc. 1 CC)."),
      createConcept("90. ¿En qué consiste la regla de la armonía de las cláusulas?", "Art. 1564 inc. 1 CC: las cláusulas de un contrato se interpretarán unas por otras, dándole a cada una el sentido que mejor convenga al contrato en su totalidad. El intérprete debe analizar la totalidad del contrato como un todo orgánico y coherente, ya que lo normal es que las cláusulas estén subordinadas unas a otras."),
      createConcept("91. ¿En qué consiste la regla de la utilidad de las cláusulas?", "Art. 1562 CC: el sentido en que una cláusula puede producir algún efecto deberá preferirse a aquel en que no sea capaz de producir efecto alguno. Si una cláusula puede interpretarse de dos formas — una sin efecto y otra con efecto —, debe preferirse la segunda. La idea central es suponer que las partes no han deseado introducir cláusulas inútiles o sin sentido."),
      createConcept("92. ¿En qué consiste la regla del sentido natural del contrato?", "Art. 1563 inc. 1 CC: en aquellos casos en que no apareciere voluntad contraria, deberá estarse a la interpretación que mejor cuadre con la naturaleza del contrato. Según Pothier: cuando en un contrato los términos son susceptibles de dos sentidos, debe entendérselos en el sentido más conveniente a la naturaleza del contrato."),
      createConcept("93. ¿Cuáles son las reglas de interpretación relativas a los elementos extrínsecos del contrato?", "Se refiere a circunstancias que configuran el contorno del contrato: a. Regla de aplicación restringida del texto contractual (Art. 1561). b. Regla de la natural extensión del contrato y de la declaración (Art. 1565). c. Regla de los otros contratos de las partes sobre igual materia (Art. 1564 inc. 2). d. Regla de la ejecución práctica o interpretación auténtica (Art. 1564 inc. 3)."),
      createConcept("94. ¿En qué consiste la regla de aplicación restringida del texto contractual?", "Art. 1561 CC: por generales que sean los términos de un contrato, solo se aplicarán a la materia sobre que se ha contratado. El intérprete no puede exceder del marco objetivo de la convención. Ej.: Art. 2462 CC en la transacción: la renuncia general de todo derecho solo se entiende respecto del objeto u objetos sobre que se transige."),
      createConcept("95. ¿En qué consiste la regla de la natural extensión del contrato y de la declaración?", "Art. 1565 CC: cuando en un contrato se ha expresado un caso para explicar la obligación, no se entenderá por solo eso haberse querido restringir la convención a ese caso, excluyendo los otros a que naturalmente se extienda. Los ejemplos puestos en un contrato no implican que se aplique solo al caso puesto como ejemplo. La aparente contradicción con la regla anterior es solo aparente; son manifestaciones distintas del mismo principio general."),
      createConcept("96. ¿En qué consiste la regla de los otros contratos de las partes sobre igual materia?", "Art. 1564 inc. 2 CC: las cláusulas de un contrato podrán también interpretarse por las de otro contrato entre las mismas partes y sobre la misma materia. Esta regla permite al juez buscar la intención de las partes en otra convención, otorgada con anterioridad o posterioridad al contrato objeto de la interpretación."),
      createConcept("97. ¿En qué consiste la regla de la interpretación auténtica?", "Art. 1564 inc. 3 CC: podrán también interpretarse por la aplicación práctica que hayan hecho de ellas ambas partes, o una de las partes con aprobación de la otra. Es considerada por muchos autores como la más importante de las reglas de interpretación, porque es en la aplicación del contrato donde queda mejor clarificada la intención que tuvieron las partes."),
      createConcept("98. ¿Cuáles son las reglas subsidiarias de interpretación contractual?", "a. Regla de las cláusulas usuales (Arts. 1564 y 1563 inc. 2). b. Regla de la última alternativa (Art. 1566 inc. 1)."),
      createConcept("99. ¿En qué consiste la regla de las cláusulas usuales?", "Art. 1563 inc. 2 CC: las cláusulas de uso común se presumen aunque no se expresen. Consecuencia de la referencia del Art. 1546 CC a la costumbre. Su objeto es incorporar al contrato las cláusulas usuales silenciadas en la declaración. Tiene poca aplicación práctica porque la costumbre en materia civil solo tiene valor según ley."),
      createConcept("100. ¿En qué consiste la regla de la última alternativa?", "Art. 1566 inc. 1 CC: no pudiendo aplicarse ninguna de las reglas precedentes de interpretación, se interpretarán las cláusulas ambiguas a favor del deudor. Se utiliza como último recurso. La jurisprudencia ha aplicado este precepto especialmente respecto de los contratos de adhesión."),
    ],
  },
];
                    ...
                    return (
                      <div key={modName} className="module-item" style={{ opacity: isPlaceholder ? 0.45 : 1 }}>
                        <div
                          ...
                          onClick={() => mod && !isPlaceholder && setExpandedModules(p => ({ ...p, [mod.id]: !p[mod.id] }))}
                        ...
                        >
                          ...
                          {!isPlaceholder && <span className={`module-chevron${isExpanded ? " open" : ""}`}>▶</span>}
                        </div>
                        ...
                        {isExpanded && mod && (
                          <div className="concept-list">
                            ...
                            {isEditor && (addingConcept === mod.id ? (
                              <div className="add-form" style={{ paddingLeft: 0, paddingRight: 0 }}>
                                <input className="input-field" placeholder="Pregunta…" value={newConceptQ} onChange={e => setNewConceptQ(e.target.value)} />
                                <textarea className="input-field" placeholder="Respuesta…" value={newConceptA} onChange={e => setNewConceptA(e.target.value)} />
                                <div style={{ display: "flex", gap: 5 }}>
                                  <button className="btn btn-primary" style={{ flex: 1, justifyContent: "center" }} onClick={() => addConcept(mod.id)}>Añadir</button>
                                  <button className="btn btn-ghost" onClick={() => setAddingConcept(null)}>✕</button>
                                </div>
                              </div>
                            ) : (
                              <button className="btn btn-ghost btn-full" style={{ marginTop: 8 }} onClick={() => setAddingConcept(mod.id)}>+ Concepto individual</button>
                            ))}

                            {isEditor && (confirmDeleteId === mod.id ? (
                              <div style={{ display: "flex", gap: 5, marginTop: 8 }}>
                                <button className="btn btn-danger" style={{ flex: 1, justifyContent: "center" }} onClick={() => deleteModule(mod.id)}>Confirmar</button>
                                <button className="btn btn-ghost" style={{ flex: 1, justifyContent: "center" }} onClick={() => setConfirmDeleteId(null)}>Cancelar</button>
                              </div>
                            ) : (
                              <button className="btn btn-danger btn-full" style={{ marginTop: 8 }} onClick={() => setConfirmDeleteId(mod.id)}>Eliminar módulo</button>
                            ))}
                          </div>
                        )}
                      </div>
            ...
            <div className="study-center">
              ...
              {!sessionActive && modules.filter(m => m.concepts.length > 0 && activeModules.has(m.id)).length > 0 && (
                <div className="module-selector-block">
                  ...
                  {/* Lista de módulos incluidos — solo en modos pool, debajo de extensión */}
                  {materiaMode !== "module" && (
                    <div style={{ fontSize: 10, color: "var(--text-muted)", marginTop: 8, lineHeight: 1.7 }}>
                      {modules.filter(m => {
                        if (!activeModules.has(m.id) || m.concepts.length === 0) return false;
                        if (materiaMode === "civil") return ["Acto Jurídico","Teoría de las Obligaciones","Contratos General","Teoría de los Bienes","Contratos Parte Especial","Personas","Familia","Sucesorio","Daños"].includes(m.name);
                        if (materiaMode === "procesal") return ["Procesal Orgánico","Proceso y Procedimiento","Ordinario y Sumario","Ejecutivo y Juicios Especiales","Recursos Civiles","Procesal Penal","Recursos Penales"].includes(m.name);
                        return true;
                      }).map(m => m.name).join(" · ")}
                    </div>
                  )}
              ...
              {queue.length > 0 && (
                <div className="progress-bar-wrap">
                  <div className="progress-info">
                    <span>{materiaMode === "all" ? "Popurrí de ramos" : materiaMode === "civil" ? "Todo Derecho Civil" : materiaMode === "procesal" ? "Todo Derecho Procesal" : <>Test de <b>{modules[currentModuleIdx]?.name}</b>{injectedCount > 0 ? ` · repasando ${injectedCount} pregunta${injectedCount !== 1 ? "s" : ""} del resto de asignaturas` : ""}</>}</span>
